...
description: Bridge pattern, channel wiring, and code examples for the game-thread/I-O-thread boundary. Detail companion to TFS-threading — the invariant.
globs: ["crates/tfs-rust-net/**/*.rs", "crates/tfs-rust-core/**/*.rs", "crates/tfs-rust-db/**/*.rs"]
---

# Threading Patterns (Game Thread vs I/O Threads)

The invariant this file implements is defined in `@.cursor/rules/TFS-threading.mdc` — read that first.
