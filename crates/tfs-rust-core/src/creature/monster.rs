...
impl Default for MonsterAiConfig {
    fn default() -> Self {
        ...
        Self {
            ...
            lose_target_percent: d.lose_target_percent,
            strategy_nearest: d.strategy_nearest,
            strategy_health: d.strategy_health,
            strategy_damage: d.strategy_damage,
            talks: 0,
            melee_skill: 0,
            melee_attack: 0,
            poison_cycles: 0,
...
impl From<MonsterTypeFlags> for MonsterAiConfig {
    fn from(f: MonsterTypeFlags) -> Self {
        Self {
            ...
            lose_target_percent: f.lose_target_percent,
            strategy_nearest: f.strategy_nearest,
            strategy_health: f.strategy_health,
            strategy_damage: f.strategy_damage,
            talks: 0,
            melee_skill: 0,
            melee_attack: 0,
            poison_cycles: 0,
...
pub struct Monster {
    ...
    pub talk_texts: Arc<[String]>,
    pub melee_skill: i32,
    /// 772 fist `TSkillProbe::Exp` — `Increase(1)` before `Get` (`crskill.cc:532`).
    pub melee_skill_tries: u64,
    pub melee_attack: i32,
    pub poison_cycles: i32,
