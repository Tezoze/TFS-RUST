...
2. **D1 + D2 + D3** — interlocked; one commit. Removes a wrong error code and matches the
   772 cross-floor stacking quirk. Needs sign-off because it removes a safety gate.
