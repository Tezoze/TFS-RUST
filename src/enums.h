...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_DURATION_TIMESTAMP = 1 << 28,
	ITEM_ATTRIBUTE_CONTAINERSIZE = 1 << 29,
...
enum ClientDamageType : uint8_t {
	CLIENT_DAMAGETYPE_PHYSICAL = 1,
	CLIENT_DAMAGETYPE_ENERGY = 2,
	CLIENT_DAMAGETYPE_EARTH = 3,
	CLIENT_DAMAGETYPE_FIRE = 4,
	CLIENT_DAMAGETYPE_HEALING = 5,
	CLIENT_DAMAGETYPE_DROWN = 6,
	CLIENT_DAMAGETYPE_ICE = 7,
	CLIENT_DAMAGETYPE_HOLY = 8,
	CLIENT_DAMAGETYPE_DEATH = 9,
	CLIENT_DAMAGETYPE_LIFEDRAIN = 10,
	CLIENT_DAMAGETYPE_UNDEFINED = 11
};

enum DamageAnalyzerImpactType : uint8_t {
	DAMAGE_ANALYZER_HEALING = 0,
	DAMAGE_ANALYZER_DEALT = 1,
	DAMAGE_ANALYZER_RECEIVED = 2
};
