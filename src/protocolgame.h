...
class ProtocolGame final : public Protocol
{
	...
	void sendTextMessage(const TextMessage& message);
		...
		void sendLootStats(const Item* item, const std::string& creatureName);
		void sendKillTracker(const std::string& monsterName, const Outfit_t& outfit, const std::vector<const Item*>& corpseItems);
