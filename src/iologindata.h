...
class IOLoginData
{
	...
	private:
		...
		static bool saveItems(const Player* player, const ItemBlockList& itemList, DBInsert& query_insert, PropWriteStream& propWriteStream, const std::map<Container*, int32_t>& openContainers);
};
