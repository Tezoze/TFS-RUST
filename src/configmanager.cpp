...
bool ConfigManager::load()
{
	...
	boolean[PACKET_COMPRESSION_ENABLED] = getGlobalBoolean(L, "packetCompressionEnabled", false);
	boolean[PACKET_COMPRESSION_DEBUG] = getGlobalBoolean(L, "packetCompressionDebug", false);
	boolean[MYSQL_CONNECTION_POOL_ENABLED] = getGlobalBoolean(L, "mysqlConnectionPoolEnabled", false);
	...
	integer[MYSQL_CONNECTION_POOL_SIZE] = getGlobalNumber(L, "mysqlConnectionPoolSize", 10);
	integer[MYSQL_CONNECTION_MAX_POOL_SIZE] = getGlobalNumber(L, "mysqlConnectionMaxPoolSize", 50);
	integer[MYSQL_CONNECTION_MIN_POOL_SIZE] = getGlobalNumber(L, "mysqlConnectionMinPoolSize", 2);
	integer[MYSQL_CONNECTION_TIMEOUT] = getGlobalNumber(L, "mysqlConnectionTimeout", 300);
	integer[MYSQL_CONNECTION_ACQUIRE_TIMEOUT] = getGlobalNumber(L, "mysqlConnectionAcquireTimeout", 30);
	integer[PACKET_COMPRESSION_LEVEL] = getGlobalNumber(L, "packetCompressionLevel", 6);
	integer[SPOOF_ONLINE_COUNT] = getGlobalNumber(L, "spoofOnlineCount", 0);
	integer[MAX_PLAYERS_PER_ACCOUNT] = getGlobalNumber(L, "maxPlayersPerAccount", 1);
