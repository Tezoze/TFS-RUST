...
void mainLoader(int, char*[], ServiceManager* services)
{
	...
	std::cout << ">> Initializing stability manager" << std::endl;
	try {
		StabilityManager::getInstance().initialize();
	} catch (const std::exception& e) {
		startupErrorMessage(std::string("Failed to initialize stability manager: ") + e.what());
		return;
	}
