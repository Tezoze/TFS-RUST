...
enum AttrTypes_t {
	...
	ATTR_AUTOOPEN = ATTR_OPENCONTAINER, // alias for compatibility
	ATTR_PODIUMOUTFIT = 40,
	ATTR_TIER = 41,
	ATTR_CONTAINERSIZE = 42,
};
...
class ItemAttributes
{
	...
	private:
		...
		const static uint32_t intAttributeTypes = ITEM_ATTRIBUTE_ACTIONID | ITEM_ATTRIBUTE_UNIQUEID | ITEM_ATTRIBUTE_DATE
			...
			| ITEM_ATTRIBUTE_ATTACK_SPEED | ITEM_ATTRIBUTE_AUTOOPEN | ITEM_ATTRIBUTE_DURATION_TIMESTAMP
			| ITEM_ATTRIBUTE_CONTAINERSIZE;
