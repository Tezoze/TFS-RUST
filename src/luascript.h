...
class LuaScriptInterface
{
	public:
		...
		static const luaL_Reg luaDatabaseTable[16];
	...
	private:
		...
		static int luaDatabaseGetPoolSize(lua_State* L);
		static int luaDatabaseGetActiveConnections(lua_State* L);
		static int luaDatabaseGetAvailableConnections(lua_State* L);
		static int luaDatabaseGetActiveTransactionCount(lua_State* L);
		static int luaGetBufferedProtocolsCount(lua_State* L);
		static int luaAddProtocolToAutosend(lua_State* L);
		static int luaRemoveProtocolFromAutosend(lua_State* L);
		...
		static int luaPlayerSetPassThroughMode(lua_State* L);
		...
		static int luaNpcTypeGetShopItems(lua_State* L);
