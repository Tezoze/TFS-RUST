...
8. **After this folder** — remaining actions APIs **R3–R5** (map chests + mintwallin `createTile`). E3 already covers tool `destroyItem`. R1–R2 shipped. Then G10 `decay(id)`, G12.
