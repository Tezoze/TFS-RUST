...
- **Data-pack Lua (772 corpus):** [docs/DATA_PACK_LUA.md](../docs/DATA_PACK_LUA.md). **Phases 1–5 done** (scripts-interface, CreatureEvent dispatch, login primitives, Monster spawn-mutate / rarity hook, `events.xml` retired). Phases 6–8 not implemented. Plan: [data-pack-lua-implementation-plan.md](data-pack-lua-implementation-plan.md).
