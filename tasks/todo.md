...
- **Data-pack Lua (772 corpus):** [docs/DATA_PACK_LUA.md](../docs/DATA_PACK_LUA.md) — spawn-only loot; Lua vs native. **Phases 1–3 done** (scripts-interface, CreatureEvent dispatch, login/firstlogin/death primitives; no `db` surface). Phases 4–8 not implemented. Plan: [data-pack-lua-implementation-plan.md](data-pack-lua-implementation-plan.md).
