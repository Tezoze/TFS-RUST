...
monster.attacks = {
	...
	{name = "condition", type = CONDITION_FIRE, interval = 1000, chance = 7, tick = 10000, minDamage = -800, maxDamage = -1200, range = 2, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_YELLOWSPARK, target = true},
	{name = "combat", type = COMBAT_PHYSICALDAMAGE, minDamage = -250, maxDamage = -750, interval = 1000, chance = 7, radius = 6, target = false, effect = CONST_ME_EXPLOSION},
	{name = "combat", type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -500, interval = 1000, chance = 50, radius = 5, target = false, effect = CONST_ME_YELLOWSPARK},
	{name = "firefield", interval = 1000, chance = 4, radius = 8, target = false, effect = CONST_ME_EXPLOSION},
	{name = "combat", type = COMBAT_FIREDAMAGE, minDamage = -350, maxDamage = -850, interval = 1000, chance = 34, range = 7, radius = 7, target = true, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA},
	{name = "combat", type = COMBAT_FIREDAMAGE, minDamage = -500, maxDamage = -1000, interval = 1000, chance = 13, length = 8, spread = 0, target = false, effect = CONST_ME_EXPLOSION},
	{name = "combat", type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -1500, interval = 1000, chance = 10, length = 8, spread = 3, target = false, effect = CONST_ME_FIREAREA},
}
...
monster.defenses = {
	...
	{name = "speed", interval = 1000, chance = 10, effect = CONST_ME_REDSHIMMER, speed = 1800, duration = 4000},
}
