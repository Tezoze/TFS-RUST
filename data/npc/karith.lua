-- Karith - Converted from XML to Lua NpcType
-- Original XML: data/npc/Karith.xml
-- Original Script: data/npc/scripts/Karith.lua

local npcName = "Karith"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a karith")
npcType:health(100)
...
npcType:outfit({lookType = 159, lookHead = 79, lookBody = 3, lookLegs = 93, lookFeet = 12})
...
local player = Player(cid)
	...
	elseif msgcontains(msg, "blood crystal") then
		npcHandler:say("I'm not interested in stuff like that.", cid)
		return true
