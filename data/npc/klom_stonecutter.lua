-- Klom Stonecutter - Converted from XML to Lua NpcType
-- Original XML: data/npc/Klom Stonecutter.xml
-- Original Script: data/npc/scripts/Klom Stonecutter.lua
...
npcType:nameDescription("a klom stonecutter")
npcType:health(100)
...
npcType:outfit({lookType = 160, lookHead = 3, lookBody = 77, lookLegs = 68, lookFeet = 76})
