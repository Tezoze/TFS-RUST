-- Fenbala - Converted from XML to Lua NpcType
-- Original XML: data/npc/Fenbala.xml
-- Original Script: data/npc/scripts/Fenbala.lua

local npcName = "Fenbala"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a fenbala")
npcType:health(100)
...
npcType:outfit({lookType = 139, lookHead = 77, lookBody = 71, lookLegs = 100, lookFeet = 115})
