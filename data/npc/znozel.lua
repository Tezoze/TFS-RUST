-- Znozel - Converted from XML to Lua NpcType
-- Original XML: data/npc/Znozel.xml
-- Original Script: data/npc/scripts/Znozel.lua
...
npcType:nameDescription("a znozel")
npcType:health(100)
