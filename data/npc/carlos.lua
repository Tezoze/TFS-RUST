-- Carlos - Converted from XML to Lua NpcType
-- Original XML: data/npc/Carlos.xml
-- Original Script: data/npc/scripts/Carlos.lua

local npcName = "Carlos"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a carlos")
npcType:health(100)
...
npcType:outfit({lookType = 132, lookHead = 114, lookBody = 94, lookLegs = 86, lookFeet = 114, lookAddons = 3})
