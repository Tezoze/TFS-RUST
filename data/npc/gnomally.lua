-- Gnomally - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gnomally.xml
-- Original Script: data/npc/scripts/Gnomally.lua

local npcName = "Gnomally"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gnomally")
npcType:health(100)
...
npcType:outfit({lookType = 507, lookHead = 52, lookBody = 90, lookLegs = 90, lookFeet = 90})
