-- Gnombold - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gnombold.xml
-- Original Script: data/npc/scripts/Gnombold.lua

local npcName = "Gnombold"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gnombold")
npcType:health(100)
...
npcType:outfit({lookType = 493, lookHead = 40, lookBody = 81, lookLegs = 101, lookFeet = 57})
