-- Bron - Converted from XML to Lua NpcType
-- Original XML: data/npc/Bron.xml
-- Original Script: data/npc/scripts/Bron.lua
...
npcType:nameDescription("a bron")
npcType:health(100)
...
npcType:outfit({lookType = 143, lookHead = 95, lookBody = 94, lookLegs = 132, lookFeet = 86, lookAddons = 2})
