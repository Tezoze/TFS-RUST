-- Siestaar - Converted from XML to Lua NpcType
-- Original XML: data/npc/Siestaar.xml
-- Original Script: data/npc/scripts/Siestaar.lua

local npcName = "Siestaar"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a siestaar")
npcType:health(100)
...
npcType:outfit({lookType = 288, lookHead = 129, lookBody = 128, lookLegs = 72, lookFeet = 94, lookAddons = 3})
