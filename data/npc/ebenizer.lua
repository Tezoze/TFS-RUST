-- Ebenizer - Converted from XML to Lua NpcType
-- Original XML: data/npc/Ebenizer.xml
-- Original Script: data/npc/scripts/Ebenizer.lua
...
npcType:nameDescription("a ebenizer")
npcType:health(100)
...
npcType:outfit({lookType = 128, lookHead = 59, lookBody = 95, lookLegs = 87, lookFeet = 76})
