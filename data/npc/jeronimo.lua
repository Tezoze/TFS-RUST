-- Jeronimo - Converted from XML to Lua NpcType
-- Original XML: data/npc/Jeronimo.xml
-- Original Script: data/npc/scripts/jeronimo.lua

local npcName = "Jeronimo"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a jeronimo")
npcType:health(150)
...
npcType:outfit({lookType = 132, lookHead = 57, lookBody = 59, lookLegs = 3, lookFeet = 1, lookAddons = 3})
