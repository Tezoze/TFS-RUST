-- Eva - Converted from XML to Lua NpcType
-- Original XML: data/npc/Eva.xml
-- Original Script: data/npc/scripts/Eva.lua
...
npcType:outfit({lookType = 136, lookHead = 96, lookBody = 98, lookLegs = 95})
