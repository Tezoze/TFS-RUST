-- Sven - Converted from XML to Lua NpcType
-- Original XML: data/npc/Sven.xml
-- Original Script: data/npc/scripts/Sven.lua
...
npcType:nameDescription("a sven")
npcType:health(100)
...
npcType:outfit({lookType = 143, lookHead = 76, lookBody = 57, lookLegs = 115, lookFeet = 40, lookAddons = 3})
