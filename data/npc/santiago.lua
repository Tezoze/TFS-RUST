-- Santiago - Converted from XML to Lua NpcType
-- Original XML: data/npc/Santiago.xml
-- Original Script: data/npc/scripts/Santiago.lua

local npcName = "Santiago"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a santiago")
npcType:health(100)
...
npcType:outfit({lookType = 151, lookHead = 38, lookBody = 115, lookLegs = 87, lookFeet = 114})
