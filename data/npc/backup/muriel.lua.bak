-- Muriel - Converted from XML to Lua NpcType
-- Original XML: data/npc/Muriel.xml
-- Original Script: data/npc/scripts/Muriel.lua

local npcName = "Muriel"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a muriel")
npcType:health(100)
...
npcType:outfit({lookType = 130, lookHead = 115, lookBody = 94, lookLegs = 97, lookFeet = 76})
...
local spells = {
    ...
    -- Names must match spells.xml exactly (e.g., adding " Rune")
