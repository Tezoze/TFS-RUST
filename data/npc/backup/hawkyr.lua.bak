-- Hawkyr - Converted from XML to Lua NpcType
-- Original XML: data/npc/Hawkyr.xml
-- Original Script: data/npc/scripts/Hawkyr.lua

local npcName = "Hawkyr"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a hawkyr")
npcType:health(100)
...
npcType:outfit({lookType = 143, lookHead = 97, lookBody = 116, lookLegs = 82, lookFeet = 121, lookAddons = 2})
