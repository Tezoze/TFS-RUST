-- Smiley - Converted from XML to Lua NpcType
-- Original XML: data/npc/Smiley.xml
-- Original Script: data/npc/scripts/Smiley.lua

local npcName = "Smiley"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a smiley")
npcType:health(100)
