-- Alia - Converted from XML to Lua NpcType
-- Original XML: data/npc/Alia.xml
-- Original Script: data/npc/scripts/Alia.lua
...
npcType:nameDescription("a alia")
npcType:health(100)
...
npcType:outfit({lookType = 138, lookHead = 96, lookBody = 95, lookFeet = 95})
