-- Ormuhn - Converted from XML to Lua NpcType
-- Original XML: data/npc/Ormuhn.xml
-- Original Script: data/npc/scripts/Ormuhn.lua

local npcName = "Ormuhn"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a ormuhn")
npcType:health(100)
