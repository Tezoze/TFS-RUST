-- Uso - Converted from XML to Lua NpcType
-- Original XML: data/npc/Uso.xml
-- Original Script: data/npc/scripts/Uso.lua
...
npcType:outfit({lookType = 69, lookHead = 98, lookBody = 59, lookLegs = 96, lookFeet = 115})
