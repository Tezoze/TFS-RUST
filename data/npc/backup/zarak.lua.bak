-- Zarak - Converted from XML to Lua NpcType
-- Original XML: data/npc/Zarak.xml
-- Original Script: data/npc/scripts/Zarak.lua
...
npcType:nameDescription("a zarak")
npcType:health(100)
