-- Queen Eloise - Converted from XML to Lua NpcType
-- Original XML: data/npc/Queen Eloise.xml
-- Original Script: data/npc/scripts/Queen Eloise.lua

local npcName = "Queen Eloise"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a queen eloise")
npcType:health(100)
