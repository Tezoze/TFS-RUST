-- Shalmar - Converted from XML to Lua NpcType
-- Original XML: data/npc/Shalmar.xml
-- Original Script: data/npc/scripts/Shalmar.lua

local npcName = "Shalmar"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a shalmar")
npcType:health(100)
...
npcType:outfit({lookType = 130, lookHead = 95, lookBody = 7, lookLegs = 65})
...
local spells = {
    ...
    -- CONJURE SPELLS (Runes - Renamed to match server XML)
