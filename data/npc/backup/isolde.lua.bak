-- Isolde - Converted from XML to Lua NpcType
-- Original XML: data/npc/Isolde.xml
-- Original Script: data/npc/scripts/Isolde.lua

local npcName = "Isolde"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a isolde")
npcType:health(100)
...
npcType:outfit({lookType = 139, lookHead = 19, lookBody = 33, lookLegs = 109, lookFeet = 128, lookAddons = 1})
