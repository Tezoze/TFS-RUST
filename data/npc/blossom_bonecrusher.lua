-- Blossom Bonecrusher - Converted from XML to Lua NpcType
-- Original XML: data/npc/Blossom Bonecrusher.xml
-- Original Script: data/npc/scripts/Blossom Bonecrusher.lua

local npcName = "Blossom Bonecrusher"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a blossom bonecrusher")
npcType:health(100)
...
npcType:outfit({lookType = 139, lookHead = 96, lookLegs = 100, lookFeet = 95})
