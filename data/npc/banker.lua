-- Banker - Converted from XML to Lua NpcType
-- Original XML: data/npc/Banker.xml
-- Original Script: data/npc/scripts/bank.lua
...
npcType:nameDescription("a banker")
npcType:health(100)
...
npcType:outfit({lookType = 128, lookHead = 40, lookBody = 95, lookLegs = 114, lookFeet = 27, lookAddons = 1})
...
if count then count[cid] = nil end
if transfer then transfer[cid] = nil end
	return true
end
