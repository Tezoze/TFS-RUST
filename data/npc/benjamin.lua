-- Benjamin - Converted from XML to Lua NpcType
-- Original XML: data/npc/Benjamin.xml
-- Original Script: data/npc/scripts/Benjamin.lua

local npcName = "Benjamin"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a benjamin")
npcType:health(100)
...
npcType:outfit({lookType = 128, lookHead = 116, lookBody = 79, lookLegs = 117, lookFeet = 76})
