-- Buddel Okolnir - Converted from XML to Lua NpcType
-- Original XML: data/npc/Buddel Okolnir.xml
-- Original Script: data/npc/scripts/Buddel Okolnir.lua

local npcId = "Buddel Okolnir"  -- Unique ID for spawn system
