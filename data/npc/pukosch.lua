-- Pukosch - Converted from XML to Lua NpcType
-- Original XML: data/npc/Pukosch.xml
-- Original Script: data/npc/scripts/Pukosch.lua

local npcName = "Pukosch"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a pukosch")
npcType:health(100)
