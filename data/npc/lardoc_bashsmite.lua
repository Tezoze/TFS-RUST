-- Lardoc Bashsmite - Converted from XML to Lua NpcType
-- Original XML: data/npc/Lardoc Bashsmite.xml
-- Original Script: data/npc/scripts/Lardoc Bashsmite.lua
...
npcType:nameDescription("a lardoc bashsmite")
npcType:health(100)
...
npcType:outfit({lookType = 160, lookHead = 57, lookBody = 47, lookLegs = 47, lookFeet = 76})
