-- Shauna - Converted from XML to Lua NpcType
-- Original XML: data/npc/Shauna.xml
-- Original Script: data/npc/scripts/Shauna.lua

local npcName = "Shauna"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a shauna")
npcType:health(100)
...
npcType:outfit({lookType = 139, lookHead = 78, lookBody = 95, lookLegs = 38, lookFeet = 58})
