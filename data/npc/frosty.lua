-- Frosty - Converted from XML to Lua NpcType
-- Original XML: data/npc/Frosty.xml
-- Original Script: data/npc/scripts/Frosty.lua

local npcName = "Frosty"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a frosty")
npcType:health(100)
