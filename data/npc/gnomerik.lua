-- Gnomerik - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gnomerik.xml
-- Original Script: data/npc/scripts/Gnomerik.lua

local npcName = "Gnomerik"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gnomerik")
npcType:health(100)
...
npcType:outfit({lookType = 493, lookHead = 3, lookBody = 60, lookLegs = 3, lookFeet = 95})
