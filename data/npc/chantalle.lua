-- Chantalle - Converted from XML to Lua NpcType
-- Original XML: data/npc/Chantalle.xml
-- Original Script: data/npc/scripts/Chantalle.lua

local npcName = "Chantalle"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a chantalle")
npcType:health(100)
...
npcType:outfit({lookType = 140, lookHead = 79, lookBody = 37, lookLegs = 71, lookFeet = 70})
