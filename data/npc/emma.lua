-- Emma - Converted from XML to Lua NpcType
-- Original XML: data/npc/Emma.xml
-- Original Script: data/npc/scripts/Emma.lua
...
npcType:nameDescription("a emma")
npcType:health(100)
...
npcType:outfit({lookType = 139, lookHead = 79, lookBody = 90, lookLegs = 52, lookFeet = 15})
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 2 then
			if player:removeItem(8190, 1) then
				...
				player:setStorageValue(12553, 2) -- Mission 1: Spellbook delivered to Emma
		...
		elseif npcHandler.topic[cid] == 3 then
			if player:removeItem(7736, 1) then
				...
				player:setStorageValue(12556, 2) -- Mission 2: Heart delivered to Emma
		...
		elseif npcHandler.topic[cid] == 4 then
			...
			player:setStorageValue(12559, 3) -- Mission 3: Rust bugs used on Ironhouse
		...
		elseif npcHandler.topic[cid] == 5 then
			if player:removeItem(7702, 1) then
				...
				player:setStorageValue(12562, 2) -- Mission 4: Building plans delivered to Emma
		...
		elseif npcHandler.topic[cid] == 6 then
			if player:removeItem(7703, 1) then
				...
				player:setStorageValue(12565, 2) -- Mission 5: Suspicious documents delivered to Emma
		...
		elseif npcHandler.topic[cid] == 7 then
			if player:removeItem(7704, 1) then
				...
				player:setStorageValue(12568, 2) -- Mission 6: Book delivered to Emma
	...
	elseif msgcontains(msg, 'mission') then
		if player:getStorageValue(Storage.secretService.Quest) == 1 then
			...
			player:setStorageValue(12553, 1) -- Mission 1: Borrowed Knowledge
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.secretService.CGBMission01) == 2 and player:getStorageValue(Storage.secretService.Quest) == 3 then
			...
			player:setStorageValue(12556, 1) -- Mission 2: Codename:Lumberjack
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.secretService.CGBMission02) == 2 and player:getStorageValue(Storage.secretService.Quest) == 5 then
			...
			player:setStorageValue(12559, 1) -- Mission 3: Rust in Peace
		...
		elseif player:getStorageValue(Storage.secretService.CGBMission03) == 3 and player:getStorageValue(Storage.secretService.Quest) == 7 then
			...
			player:setStorageValue(12562, 1) -- Mission 4: Plot for A Plan
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.secretService.CGBMission04) == 2 and player:getStorageValue(Storage.secretService.Quest) == 9 then
			...
			player:setStorageValue(12565, 1) -- Mission 5: No Admittance
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.secretService.CGBMission05) == 2 and player:getStorageValue(Storage.secretService.Quest) == 11 then
			...
			player:setStorageValue(12568, 1) -- Mission 6: News From the Past
			npcHandler:say({
