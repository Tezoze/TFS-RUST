-- Willard - Converted from XML to Lua NpcType
-- Original XML: data/npc/Willard.xml
-- Original Script: data/npc/scripts/Willard.lua

local npcName = "Willard"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a willard")
npcType:health(100)
...
npcType:outfit({lookType = 131, lookHead = 58, lookBody = 104, lookFeet = 116})
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "package for rashid") then
		if player:getStorageValue(Storage.TheTravellingTraderQuest.Mission02) >= 1 and player:getStorageValue(Storage.TheTravellingTraderQuest.Mission02) < 4 then
			npcHandler:say({
	...
	elseif msgcontains(msg, "yes") then
		if npcHandler.topic[cid] == 1 then
			...
			player:setStorageValue(Storage.TheTravellingTraderQuest.Mission02, 2)
...
local shopItems = {
    ...
    {id = 2429, buy = 0, sell = 185, subType = 0, name = "barbarian axe"},
    ...
    {id = 2423, buy = 0, sell = 170, subType = 0, name = "clerical mace"},
    ...
    {id = 2429, buy = 590, sell = 0, subType = 0, name = "barbarian axe"},
    ...
    {id = 2423, buy = 540, sell = 0, subType = 0, name = "clerical mace"},
    {id = 2382, buy = 5, sell = 0, subType = 0, name = "club"},
    {id = 2651, buy = 8, sell = 0, subType = 0, name = "coat"},
    {id = 7385, buy = 610, sell = 0, subType = 0, name = "crimson sword"},
