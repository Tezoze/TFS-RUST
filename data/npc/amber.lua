-- Amber - Converted from XML to Lua NpcType
-- Original XML: data/npc/Amber.xml
-- Original Script: data/npc/scripts/Amber.lua
...
npcType:nameDescription("a amber")
npcType:health(100)
...
npcType:outfit({lookType = 136, lookHead = 59, lookBody = 113, lookLegs = 132, lookFeet = 76, lookAddons = 1})
