-- Helor - Converted from XML to Lua NpcType
-- Original XML: data/npc/Helor.xml
-- Original Script: data/npc/scripts/Helor.lua
...
npcType:nameDescription("a helor")
npcType:health(100)
...
npcType:outfit({lookType = 134, lookHead = 76, lookBody = 60, lookLegs = 114, lookFeet = 41})
