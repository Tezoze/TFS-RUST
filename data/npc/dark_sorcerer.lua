-- Dark Sorcerer - Converted from XML to Lua NpcType
-- Original XML: data/npc/Dark Sorcerer.xml
-- Original Script: data/npc/scripts/spells/flamVis.lua

local npcName = "Dark Sorcerer"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a dark sorcerer")
npcType:health(100)
