-- Iyad - Converted from XML to Lua NpcType
-- Original XML: data/npc/Iyad.xml
-- Original Script: data/npc/scripts/Iyad.lua
...
npcType:nameDescription("a iyad")
npcType:health(100)
...
npcType:outfit({lookType = 146, lookHead = 75, lookBody = 94, lookLegs = 106, lookFeet = 76, lookAddons = 3})
