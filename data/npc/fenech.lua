-- Fenech - Converted from XML to Lua NpcType
-- Original XML: data/npc/Fenech.xml
-- Original Script: data/npc/scripts/Fenech.lua

local npcName = "Fenech"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a fenech")
npcType:health(100)
...
npcType:outfit({lookType = 132, lookHead = 76, lookBody = 40, lookLegs = 49, lookFeet = 117})
