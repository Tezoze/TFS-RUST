-- Finarfin - Converted from XML to Lua NpcType
-- Original XML: data/npc/Finarfin.xml
-- Original Script: data/npc/scripts/Finarfin.lua

local npcName = "Finarfin"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a finarfin")
npcType:health(100)
