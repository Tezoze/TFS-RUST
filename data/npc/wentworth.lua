-- Wentworth - Converted from XML to Lua NpcType
-- Original XML: data/npc/Wentworth.xml
-- Original Script: data/npc/scripts/Wentworth.lua

local npcName = "Wentworth"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a wentworth")
npcType:health(100)
...
npcType:outfit({lookType = 151, lookHead = 97, lookBody = 19, lookLegs = 124, lookFeet = 115, lookAddons = 1})
