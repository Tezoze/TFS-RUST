-- Zora - Converted from XML to Lua NpcType
-- Original XML: data/npc/Zora.xml
-- Original Script: data/npc/scripts/Zora.lua
...
npcType:nameDescription("a zora")
npcType:health(100)
...
npcType:outfit({lookType = 155, lookHead = 95, lookBody = 21, lookLegs = 23, lookFeet = 114, lookAddons = 1})
...
local shopItems = {
    ...
    {id = 1998, buy = 20, sell = 0, subType = 0, name = "green backpack"},
    {id = 1991, buy = 4, sell = 0, subType = 0, name = "green bag"},
