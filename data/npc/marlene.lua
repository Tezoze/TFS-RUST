-- Marlene - Converted from XML to Lua NpcType
-- Original XML: data/npc/Marlene.xml
-- Original Script: data/npc/scripts/Marlene.lua

local npcName = "Marlene"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a marlene")
npcType:health(100)
...
npcType:outfit({lookType = 136, lookHead = 75, lookBody = 56, lookLegs = 54, lookFeet = 37})
