-- A Strange Chalice - Converted from XML to Lua NpcType
-- Original XML: data/npc/A Strange Chalice.xml
-- Original Script: data/npc/scripts/A Strange Chalice.lua

local npcName = "A Strange Chalice"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a a strange chalice")
npcType:health(100)
...
npcType:outfit({lookTypeEx = 26405})
