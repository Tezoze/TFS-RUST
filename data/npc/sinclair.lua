-- Sinclair - Converted from XML to Lua NpcType
-- Original XML: data/npc/Sinclair.xml
-- Original Script: data/npc/scripts/Sinclair.lua

local npcName = "Sinclair"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a sinclair")
npcType:health(100)
...
npcType:outfit({lookType = 133, lookHead = 21, lookBody = 38, lookLegs = 19, lookFeet = 95, lookAddons = 1})
