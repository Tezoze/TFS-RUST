-- A Sweaty Cyclops - Converted from XML to Lua NpcType
-- Original XML: data/npc/A Sweaty Cyclops.xml
-- Original Script: data/npc/scripts/A Sweaty Cyclops.lua

local npcName = "A Sweaty Cyclops"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a a sweaty cyclops")
npcType:health(100)
