-- Rapanaioisleofevil - Converted from XML to Lua NpcType
-- Original XML: data/npc/Rapanaioisleofevil.xml
-- Original Script: data/npc/scripts/Rapanaioisleofevil.lua

local npcId = "Rapanaioisleofevil"  -- Unique ID for spawn system
local npcDisplayName = "Rapanaio"  -- Name shown in-game
local npcType = Game.createNpcType(npcId)

-- NPC Properties (from XML)
npcType:name(npcDisplayName)
npcType:nameDescription("a rapanaio")
npcType:health(100)
...
npcType:outfit({lookType = 160, lookBody = 21, lookLegs = 20, lookFeet = 39})
