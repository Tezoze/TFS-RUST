-- Dukosch - Converted from XML to Lua NpcType
-- Original XML: data/npc/Dukosch.xml
-- Original Script: data/npc/scripts/Dukosch.lua

local npcName = "Dukosch"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a dukosch")
npcType:health(100)
