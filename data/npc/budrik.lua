-- Budrik - Converted from XML to Lua NpcType
-- Original XML: data/npc/Budrik.xml
-- Original Script: data/npc/scripts/Budrik.lua

local npcName = "Budrik"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a budrik")
npcType:health(100)
...
npcType:outfit({lookType = 160, lookHead = 94, lookBody = 95, lookLegs = 58, lookFeet = 114})
