-- Naji - Converted from XML to Lua NpcType
-- Original XML: data/npc/Naji.xml
-- Original Script: data/npc/scripts/Naji.lua
...
npcType:outfit({lookType = 129, lookHead = 57, lookBody = 113, lookLegs = 95, lookFeet = 113})
...
--------------------------------guild bank-----------------------------------------------
    elseif msgcontains(msg, 'deposit') then        
		local esx = Player.getExhaustion(player, 494934)
