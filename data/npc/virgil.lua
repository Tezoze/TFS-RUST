-- Virgil - Converted from XML to Lua NpcType
-- Original XML: data/npc/Virgil.xml
-- Original Script: data/npc/scripts/Virgil.lua

local npcName = "Virgil"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a virgil")
npcType:health(100)
...
npcType:outfit({lookType = 328, lookHead = 95, lookBody = 114, lookLegs = 98, lookFeet = 97})
