-- Yana - Converted from XML to Lua NpcType
-- Original XML: data/npc/Yana.xml
-- Original Script: data/npc/scripts/yana.lua
...
npcType:nameDescription("a yana")
npcType:health(100)
...
npcType:outfit({lookType = 471, lookBody = 57, lookFeet = 68, lookAddons = 2})
