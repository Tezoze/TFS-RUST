-- Oswald - Converted from XML to Lua NpcType
-- Original XML: data/npc/Oswald.xml
-- Original Script: data/npc/scripts/Oswald.lua

local npcName = "Oswald"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a oswald")
npcType:health(100)
