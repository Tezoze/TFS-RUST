-- Ulala - Converted from XML to Lua NpcType
-- Original XML: data/npc/Ulala.xml
-- Original Script: data/npc/scripts/Ulala.lua
...
npcType:nameDescription("a ulala")
npcType:health(100)
...
npcType:outfit({lookType = 154, lookHead = 57, lookBody = 57, lookLegs = 57, lookFeet = 57})
