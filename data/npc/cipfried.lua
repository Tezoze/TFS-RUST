-- Cipfried - Converted from XML to Lua NpcType
-- Original XML: data/npc/Cipfried.xml
-- Original Script: data/npc/scripts/Cipfried.lua

local npcName = "Cipfried"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a cipfried")
npcType:health(100)
...
-- Healing Logic (Quentin Style: Only on "heal" keyword)
