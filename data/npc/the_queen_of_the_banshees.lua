-- The Queen Of The Banshees - Converted from XML to Lua NpcType
-- Original XML: data/npc/The Queen Of The Banshees.xml
-- Original Script: data/npc/scripts/The Queen Of The Banshees.lua

local npcName = "The Queen Of The Banshees"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a the queen of the banshees")
npcType:health(100)
