-- Gareth - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gareth.xml
-- Original Script: data/npc/scripts/Gareth.lua

local npcName = "Gareth"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gareth")
npcType:health(100)
...
npcType:outfit({lookType = 132, lookHead = 82, lookLegs = 120, lookFeet = 38, lookAddons = 2})
