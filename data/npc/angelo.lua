-- Angelo - Converted from XML to Lua NpcType
-- Original XML: data/npc/Angelo.xml
-- Original Script: data/npc/scripts/Angelo.lua

local npcName = "Angelo"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a angelo")
npcType:health(100)
...
npcType:outfit({lookType = 145, lookHead = 96, lookBody = 114, lookLegs = 120, lookFeet = 101})
