-- Bolfona - Converted from XML to Lua NpcType
-- Original XML: data/npc/Bolfona.xml
-- Original Script: data/npc/scripts/Bolfona.lua

local npcName = "Bolfona"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a bolfona")
npcType:health(100)
...
npcType:outfit({lookType = 160, lookHead = 37, lookBody = 16, lookLegs = 54, lookFeet = 114})
...
local shopItems = {
    ...
    {id = 2696, buy = 4, sell = 0, subType = 0, name = "cheese"},
    {id = 2012, buy = 2, sell = 0, subType = 3, name = "mug of beer"},
}
