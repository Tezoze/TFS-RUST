-- Puffels - Converted from XML to Lua NpcType
-- Original XML: data/npc/Puffels.xml
-- Original Script: data/npc/scripts/Puffels.lua

local npcName = "Puffels"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a puffels")
npcType:health(100)
...
-- Sort spells by name length (longest first) to ensure "Intense Recovery" matches before "Recovery"
local sortedSpells = {}
for _, spell in ipairs(spells) do
