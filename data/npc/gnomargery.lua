-- Gnomargery - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gnomargery.xml
-- Original Script: data/npc/scripts/Gnomargery.lua

local npcName = "Gnomargery"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gnomargery")
npcType:health(100)
...
npcType:outfit({lookType = 507, lookHead = 96, lookBody = 92, lookLegs = 96, lookFeet = 114})
