-- Rokyn - Converted from XML to Lua NpcType
-- Original XML: data/npc/Rokyn.xml
-- Original Script: data/npc/scripts/Rokyn.lua
...
npcType:nameDescription("a rokyn")
npcType:health(100)
...
npcType:outfit({lookType = 160, lookHead = 58, lookBody = 87, lookLegs = 57, lookFeet = 114})
