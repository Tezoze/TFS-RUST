-- Henry Morgan - Converted from XML to Lua NpcType
-- Original XML: data/npc/Henry Morgan.xml
-- Original Script: data/npc/scripts/Henry Morgan.lua

local npcName = "Henry Morgan"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a henry morgan")
npcType:health(100)
...
npcType:outfit({lookType = 151, lookHead = 95, lookBody = 53, lookLegs = 109, lookFeet = 115, lookAddons = 3})
...
shopModule:addSellableItem({'melee ring'},2207, 100, 'melee ring')
