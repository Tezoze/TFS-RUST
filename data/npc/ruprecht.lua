-- Ruprecht - Converted from XML to Lua NpcType
-- Original XML: data/npc/Ruprecht.xml
-- Original Script: data/npc/scripts/Ruprecht.lua

local npcName = "Ruprecht"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a ruprecht")
npcType:health(100)
...
npcType:outfit({lookType = 153, lookHead = 59, lookBody = 115, lookLegs = 115, lookFeet = 38, lookAddons = 3})
