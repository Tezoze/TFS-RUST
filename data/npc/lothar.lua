-- Lothar - Converted from XML to Lua NpcType
-- Original XML: data/npc/Lothar.xml
-- Original Script: data/npc/scripts/Lothar.lua

local npcName = "Lothar"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a lothar")
npcType:health(100)
...
npcType:outfit({lookType = 153, lookHead = 114, lookBody = 113, lookLegs = 132, lookFeet = 132, lookAddons = 2})
