-- Captain Max Calassa - Converted from XML to Lua NpcType
-- Original XML: data/npc/Captain Max Calassa.xml
-- Original Script: data/npc/scripts/Captain Max Calassa.lua

local npcId = "Captain Max Calassa"  -- Unique ID for spawn system
local npcDisplayName = "Captain Max"  -- Name shown in-game
...
local shopItems = {
    {id = 5461, buy = 0, sell = 5000, subType = 0, name = "helmet of the deep"},
    {id = 5461, buy = 5000, sell = 0, subType = 0, name = "helmet of the deep"},
}
