-- Kevin - Converted from XML to Lua NpcType
-- Original XML: data/npc/Kevin.xml
-- Original Script: data/npc/scripts/Kevin.lua
...
npcType:nameDescription("a kevin")
npcType:health(100)
...
npcType:outfit({lookType = 128, lookHead = 76, lookBody = 43, lookLegs = 38, lookFeet = 76})
