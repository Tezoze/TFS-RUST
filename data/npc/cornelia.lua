-- Cornelia - Converted from XML to Lua NpcType
-- Original XML: data/npc/Cornelia.xml
-- Original Script: data/npc/scripts/Cornelia.lua

local npcName = "Cornelia"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a cornelia")
npcType:health(100)
...
npcType:outfit({lookType = 139, lookHead = 95, lookBody = 76, lookLegs = 100, lookFeet = 115})
