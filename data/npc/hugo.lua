-- Hugo - Converted from XML to Lua NpcType
-- Original XML: data/npc/Hugo.xml
-- Original Script: data/npc/scripts/Hugo.lua
...
npcType:nameDescription("a hugo")
npcType:health(100)
...
npcType:outfit({lookType = 130, lookHead = 14, lookBody = 81, lookLegs = 80})
