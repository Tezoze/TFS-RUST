-- Brokkr - Converted from XML to Lua NpcType
-- Original XML: data/npc/Brokkr.xml
-- Original Script: data/npc/scripts/Brokkr.lua

local npcName = "Brokkr"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a brokkr")
npcType:health(100)
