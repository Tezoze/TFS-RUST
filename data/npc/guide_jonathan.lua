-- Guide Jonathan - Converted from XML to Lua NpcType
-- Original XML: data/npc/Guide Jonathan.xml
-- Original Script: data/npc/scripts/Guide Jonathan.lua

local npcName = "Guide Jonathan"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a guide jonathan")
npcType:health(100)
...
npcType:outfit({lookType = 134, lookHead = 116, lookBody = 3, lookFeet = 117})
...
local voices = {
	...
	{ text = 'Hello, is this your first visit to Edron? I can show you around a little.' },
	{ text = 'I can tell you all about the status this world is in.' },
	{ text = 'Talk to me if you need directions.' },
	{ text = 'Need some help finding your way through Edron?' }
}
...
keywordHandler:addKeyword({'temple'}, StdModule.say, {npcHandler = npcHandler, text = 'The temple is in the northern part of Edron.'})
keywordHandler:addKeyword({'bank'}, StdModule.say, {npcHandler = npcHandler, text = 'The bank is in the northern part of Edron.'})
...
keywordHandler:addKeyword({'depot'}, StdModule.say, {npcHandler = npcHandler, text = 'The depot is in the northern part of Edron. You are also protected against attacks there. I escort newcomers there.'})
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = 'I\'ll help you find your way through Edron. I can mark important locations on your map and give you some information about the town and the world status.'})
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = 'Edron is a large and wealthy city, protected by the swamp to the south. We have a lot of shops here as well as the usual facilities like depot, temple and so on.'})
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, text = 'I\'m Jonathan, at your service!'})

npcHandler:setMessage(MESSAGE_GREET, "Welcome to Edron, |PLAYERNAME| Would you like some information and a {map} guide?")
