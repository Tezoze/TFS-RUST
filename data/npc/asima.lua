-- Asima - Converted from XML to Lua NpcType
-- Original XML: data/npc/Asima.xml
-- Original Script: data/npc/scripts/Asima.lua
...
npcType:nameDescription("a asima")
npcType:health(100)
...
npcType:outfit({lookType = 138, lookHead = 59, lookBody = 70, lookLegs = 93, lookFeet = 76})
...
npcType:onSellItem(function(npc, player, itemId, subType, amount, ignoreEquipped)
    ...
    if not shopItem or not shopItem.sell or shopItem.sell <= 0 then return false end
