-- Kaya - Converted from XML to Lua NpcType
-- Original XML: data/npc/Kaya.xml
-- Original Script: data/npc/scripts/Kaya.lua
...
npcType:nameDescription("a kaya")
npcType:health(100)
...
npcType:outfit({lookType = 140, lookHead = 79, lookBody = 53, lookLegs = 53})
