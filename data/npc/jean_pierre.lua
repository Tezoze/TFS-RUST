-- Jean Pierre - Converted from XML to Lua NpcType
-- Original XML: data/npc/Jean Pierre.xml
-- Original Script: data/npc/scripts/Jean Pierre.lua

local npcName = "Jean Pierre"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a jean pierre")
npcType:health(100)
