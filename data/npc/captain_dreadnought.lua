-- Captain Dreadnought - Converted from XML to Lua NpcType
-- Original XML: data/npc/Captain Dreadnought.xml
-- Original Script: data/npc/scripts/Captain Dreadnought.lua

local npcName = "Captain Dreadnought"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a captain dreadnought")
npcType:health(100)
...
npcType:outfit({lookType = 155, lookHead = 96, lookLegs = 78, lookFeet = 96, lookAddons = 1})
