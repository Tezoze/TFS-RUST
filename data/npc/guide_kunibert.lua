-- Guide Kunibert - Converted from XML to Lua NpcType
-- Original XML: data/npc/Guide Kunibert.xml
-- Original Script: data/npc/scripts/Guide Kunibert.lua

local npcName = "Guide Kunibert"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a guide kunibert")
npcType:health(100)
...
local voices = {
	...
	{ text = 'Need some help finding your way through Rathleton?' }
}
...
keywordHandler:addKeyword({'temple'}, StdModule.say, {npcHandler = npcHandler, text = 'The temple is in the upper city of Rathleton.'})
keywordHandler:addKeyword({'bank'}, StdModule.say, {npcHandler = npcHandler, text = 'The bank is in the upper city of Rathleton.'})
...
keywordHandler:addKeyword({'depot'}, StdModule.say, {npcHandler = npcHandler, text = 'The depot is in the upper city of Rathleton. You are also protected against attacks there. I escort newcomers there.'})
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = 'I\'ll help you find your way through Rathleton. I can mark important locations on your map and give you some information about the town and the world status.'})
keywordHandler:addKeyword({'town'}, StdModule.say, {npcHandler = npcHandler, text = 'Rathleton is a technologically advanced city built on an island. We have a lot of shops here as well as the usual facilities like depot, temple and so on.'})
keywordHandler:addKeyword({'name'}, StdModule.say, {npcHandler = npcHandler, text = 'I\'m Kunibert, at your service!'})
