-- Paulie - Converted from XML to Lua NpcType
-- Original XML: data/npc/Paulie.xml
-- Original Script: data/npc/scripts/Paulie.lua

local npcName = "Paulie"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a paulie")
npcType:health(100)
...
npcType:outfit({lookType = 128, lookHead = 78, lookBody = 86, lookLegs = 114, lookFeet = 116})
