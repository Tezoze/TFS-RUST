-- Eighty - Converted from XML to Lua NpcType
-- Original XML: data/npc/Eighty.xml
-- Original Script: data/npc/scripts/Eighty.lua

local npcName = "Eighty"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a eighty")
npcType:health(100)
...
npcType:outfit({lookTypeEx = 13573})
