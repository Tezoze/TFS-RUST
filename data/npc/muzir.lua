-- Muzir - Converted from XML to Lua NpcType
-- Original XML: data/npc/Muzir.xml
-- Original Script: data/npc/scripts/Muzir.lua
...
npcType:nameDescription("a muzir")
npcType:health(100)
...
npcType:outfit({lookType = 146, lookHead = 95, lookBody = 4, lookLegs = 11, lookFeet = 76})
