-- Sarina - Converted from XML to Lua NpcType
-- Original XML: data/npc/Sarina.xml
-- Original Script: data/npc/scripts/Sarina.lua

local npcName = "Sarina"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a sarina")
npcType:health(100)
...
npcType:outfit({lookType = 136, lookHead = 41, lookBody = 72, lookLegs = 95, lookFeet = 96})
...
local shopItems = {
    ...
    {id = 2041, buy = 8, sell = 0, subType = 0, name = "candelaburm"},
    ...
    {id = 2013, buy = 3, sell = 0, subType = 0, name = "cup"},
    ...
    {id = 2331, buy = 10, sell = 0, subType = 0, name = "present"},
    {id = 2001, buy = 20, sell = 0, subType = 0, name = "purple backpack"},
    {id = 1994, buy = 5, sell = 0, subType = 0, name = "purple bag"},
