-- Tereban - Converted from XML to Lua NpcType
-- Original XML: data/npc/Tereban.xml
-- Original Script: data/npc/scripts/Tereban.lua

local npcName = "Tereban"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a tereban")
npcType:health(100)
...
npcType:outfit({lookType = 132, lookHead = 38, lookBody = 48, lookLegs = 20, lookFeet = 76})
