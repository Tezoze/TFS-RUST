-- Suzy - Converted from XML to Lua NpcType
-- Original XML: data/npc/Suzy.xml
-- Original Script: data/npc/scripts/Suzy.lua
...
npcType:nameDescription("a suzy")
npcType:health(100)
...
npcType:outfit({lookType = 136, lookHead = 78, lookBody = 10, lookLegs = 115, lookFeet = 95})
