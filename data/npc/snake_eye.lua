-- Snake Eye - Converted from XML to Lua NpcType
-- Original XML: data/npc/Snake Eye.xml
-- Original Script: data/npc/scripts/Snake Eye.lua

local npcName = "Snake Eye"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a snake eye")
npcType:health(100)
...
npcType:outfit({lookType = 73, lookHead = 20, lookBody = 30, lookLegs = 40, lookFeet = 50, lookAddons = 1})
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'package for rashid') then
		if player:getStorageValue(Storage.TheTravellingTraderQuest.Mission02) == 2 then
			...
			player:setStorageValue(Storage.TheTravellingTraderQuest.Mission02, 4)
...
local shopItems = {
    ...
    {id = 2666, buy = 4, sell = 0, subType = 0, name = "meat"},
    {id = 2667, buy = 10, sell = 0, subType = 0, name = "fish"},
    {id = 2689, buy = 10, sell = 0, subType = 0, name = "bread"},
    {id = 2012, buy = 5, sell = 0, subType = 3, name = "mug of beer"},
}
