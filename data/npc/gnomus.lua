-- Gnomus - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gnomus.xml
-- Original Script: data/npc/scripts/Gnomus.lua
...
npcType:nameDescription("a gnomus")
npcType:health(100)
...
npcType:outfit({lookType = 493, lookHead = 67, lookBody = 67, lookLegs = 67, lookFeet = 76})
