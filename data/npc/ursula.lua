-- Ursula - Converted from XML to Lua NpcType
-- Original XML: data/npc/Ursula.xml
-- Original Script: data/npc/scripts/Ursula.lua

local npcName = "Ursula"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a ursula")
npcType:health(100)
