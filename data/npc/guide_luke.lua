-- Guide Luke - Converted from XML to Lua NpcType
-- Original XML: data/npc/Guide Luke.xml
-- Original Script: data/npc/scripts/Guide Luke.lua

local npcName = "Guide Luke"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a guide luke")
npcType:health(100)
...
npcType:outfit({lookType = 131, lookHead = 132, lookBody = 39, lookLegs = 38, lookFeet = 114})
...
local voices = {
	...
	{ text = 'Need some help finding your way through Thais?' }
}
