-- Ivalisse - Converted from XML to Lua NpcType
-- Original XML: data/npc/Ivalisse.xml
-- Original Script: data/npc/scripts/Ivalisse.lua

local npcName = "Ivalisse"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a ivalisse")
npcType:health(100)
...
npcType:outfit({lookType = 138, lookHead = 2, lookBody = 19, lookLegs = 28, lookFeet = 76})
