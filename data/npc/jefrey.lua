-- Jefrey - Converted from XML to Lua NpcType
-- Original XML: data/npc/Jefrey.xml
-- Original Script: data/npc/scripts/Jefrey.lua

local npcName = "Jefrey"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a jefrey")
npcType:health(100)
...
npcType:outfit({lookType = 132, lookHead = 95, lookBody = 63, lookLegs = 38, lookFeet = 82, lookAddons = 2})
