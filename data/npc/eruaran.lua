-- Eruaran - Converted from XML to Lua NpcType
-- Original XML: data/npc/Eruaran.xml
-- Original Script: data/npc/scripts/Eruaran.lua

local npcName = "Eruaran"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a eruaran")
npcType:health(100)
