-- Thorwulf - Converted from XML to Lua NpcType
-- Original XML: data/npc/Thorwulf.xml
-- Original Script: data/npc/scripts/Thorwulf.lua

local npcName = "Thorwulf"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a thorwulf")
npcType:health(100)
...
npcType:outfit({lookType = 143, lookHead = 3, lookBody = 58, lookLegs = 97, lookFeet = 116, lookAddons = 1})
