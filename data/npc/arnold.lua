-- Arnold - Converted from XML to Lua NpcType
-- Original XML: data/npc/Arnold.xml
-- Original Script: data/npc/scripts/Arnold.lua

local npcName = "Arnold"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a arnold")
npcType:health(100)
