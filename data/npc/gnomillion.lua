-- Gnomillion - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gnomillion.xml
-- Original Script: data/npc/scripts/Gnomillion.lua

local npcName = "Gnomillion"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gnomillion")
npcType:health(100)
...
npcType:outfit({lookType = 493, lookHead = 78, lookBody = 98, lookLegs = 98, lookFeet = 60})
