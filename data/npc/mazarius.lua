-- Mazarius - Converted from XML to Lua NpcType
-- Original XML: data/npc/Mazarius.xml
-- Original Script: data/npc/scripts/Mazarius.lua

local npcName = "Mazarius"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a mazarius")
npcType:health(100)
...
npcType:outfit({lookType = 130, lookHead = 78, lookBody = 76, lookLegs = 19, lookFeet = 38, lookAddons = 1})
