-- Christoph - Converted from XML to Lua NpcType
-- Original XML: data/npc/Christoph.xml
-- Original Script: data/npc/scripts/Christoph.lua

local npcName = "Christoph"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a christoph")
npcType:health(100)
