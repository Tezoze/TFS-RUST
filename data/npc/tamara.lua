-- Tamara - Converted from XML to Lua NpcType
-- Original XML: data/npc/Tamara.xml
-- Original Script: data/npc/scripts/Tamara.lua

local npcName = "Tamara"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a tamara")
npcType:health(100)
...
-- Helper to check if player is a Druid (for conversation)
