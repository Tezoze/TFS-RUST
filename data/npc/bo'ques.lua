-- Bo'Ques - Converted from XML to Lua NpcType
-- Original XML: data/npc/Bo'Ques.xml
-- Original Script: data/npc/scripts/Boques.lua

local npcName = "Bo'Ques"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a bo'ques")
npcType:health(100)
...
local function creatureSayCallback(cid, type, msg)
	...
	local missionProgress = player:getStorageValue(Storage.DjinnWar.MaridFaction.Mission01) or -1
