-- Chrystal - Converted from XML to Lua NpcType
-- Original XML: data/npc/Chrystal.xml
-- Original Script: data/npc/scripts/Chrystal.lua

local npcName = "Chrystal"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a chrystal")
npcType:health(100)
...
npcType:outfit({lookType = 136, lookHead = 116, lookBody = 79, lookLegs = 117, lookFeet = 76})
