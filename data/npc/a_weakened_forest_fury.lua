-- A Weakened Forest Fury - Converted from XML to Lua NpcType
-- Original XML: data/npc/A Weakened Forest Fury.xml
-- Original Script: data/npc/scripts/A Weakened Forest Fury.lua

local npcName = "A Weakened Forest Fury"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a a weakened forest fury")
npcType:health(100)
