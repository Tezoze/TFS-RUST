-- Pugwah - Converted from XML to Lua NpcType
-- Original XML: data/npc/Pugwah.xml
-- Original Script: data/npc/scripts/Pugwah.lua

local npcName = "Pugwah"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a pugwah")
npcType:health(100)
...
npcType:outfit({lookType = 214, lookHead = 78, lookBody = 86, lookLegs = 114, lookFeet = 116})
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "blood crystal") then
		npcHandler:say("Big red crystal. Some people talk about it in my tavern. But strange people those are!", cid)
		return true
	end
