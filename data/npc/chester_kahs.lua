-- Chester Kahs - Converted from XML to Lua NpcType
-- Original XML: data/npc/Chester Kahs.xml
-- Original Script: data/npc/scripts/Chester Kahs.lua

local npcName = "Chester Kahs"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a chester kahs")
npcType:health(100)
...
npcType:outfit({lookType = 131, lookHead = 9, lookBody = 28, lookLegs = 47, lookFeet = 95})
...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'yes') then
		...
		elseif npcHandler.topic[cid] == 6 then
				...
				player:setStorageValue(12551, 3) -- Mission 1 completed
		...
		elseif npcHandler.topic[cid] == 7 then
			if player:removeItem(7696, 1) then
				...
				player:setStorageValue(12554, 2) -- Mission 2 completed
		...
		elseif npcHandler.topic[cid] == 8 then
			if player:removeItem(14324, 1) then
				...
				player:setStorageValue(12557, 3) -- Mission 3 completed
		...
		elseif npcHandler.topic[cid] == 9 then
			if player:removeItem(14325, 1) then
				...
				player:setStorageValue(12560, 2) -- Mission 4 completed
		...
		elseif npcHandler.topic[cid] == 10 then
			...
			player:setStorageValue(12563, 3) -- Mission 5 completed
		...
		elseif npcHandler.topic[cid] == 11 then
			...
			player:setStorageValue(Storage.secretService.TBIMission06, 3) -- Mission 6 completed
	...
	elseif msgcontains(msg, 'mission') then
		if player:getStorageValue(Storage.secretService.Quest) == 1 then
			...
			player:setStorageValue(12551, 1) -- Mission 1: From Thais with Love
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.secretService.TBIMission01) == 3 and player:getStorageValue(Storage.secretService.Quest) == 3 then
			...
			player:setStorageValue(12554, 1) -- Mission 2: Operation Green Claw
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.secretService.TBIMission02) == 2 and player:getStorageValue(Storage.secretService.Quest) == 5 then
			...
			player:setStorageValue(12557, 1) -- Mission 3: Treachery in Port Hope
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.secretService.TBIMission03) == 3 and player:getStorageValue(Storage.secretService.Quest) == 7 then
			...
			player:setStorageValue(12560, 1) -- Mission 4: Objective Hellgate
			npcHandler:say({
		...
		elseif player:getStorageValue(Storage.secretService.TBIMission04) == 2 and player:getStorageValue(Storage.secretService.Quest) == 9 then
			...
			player:setStorageValue(12563, 1) -- Mission 5: Coldfinger
		...
		elseif player:getStorageValue(Storage.secretService.TBIMission05) == 3 and player:getStorageValue(Storage.secretService.Quest) == 11 then
			...
			player:setStorageValue(Storage.secretService.TBIMission06, 1) -- Mission 6: The Weakest Spot
			player:addItem(7700, 1)
			npcHandler:say({
