-- Guide Tiko - Converted from XML to Lua NpcType
-- Original XML: data/npc/Guide Tiko.xml
-- Original Script: data/npc/scripts/Guide Tiko.lua

local npcName = "Guide Tiko"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a guide tiko")
npcType:health(100)
...
npcType:outfit({lookType = 133, lookHead = 96, lookBody = 78, lookLegs = 101, lookFeet = 116})
