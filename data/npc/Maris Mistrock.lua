-- Maris Mistrock - Converted from XML to Lua NpcType
-- Original XML: data/npc/Maris Mistrock.xml
-- Original Script: data/npc/scripts/MarisMistrock.lua

local npcId = "Maris Mistrock"  -- Unique ID for spawn system
...
-- Quest dialogue using callback function instead of StdModule.say
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mistrock") then
		npcHandler:say("Do you smell this? It's the smell of fire... the fire of a forge. Many people searched this rock here for a hidden path, but they haven't found anything. I'd search on Fenrock if you were you. Even though there's snow on the surface, it's still warm underground. There are often caves under fresh lava streams.", cid)
