-- Commander Stone - Converted from XML to Lua NpcType
-- Original XML: data/npc/Commander Stone.xml
-- Original Script: data/npc/scripts/Commander Stone.lua

local npcName = "Commander Stone"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a commander stone")
npcType:health(100)
...
npcType:outfit({lookType = 512, lookHead = 85, lookBody = 9, lookLegs = 9, lookFeet = 9, lookAddons = 3})
