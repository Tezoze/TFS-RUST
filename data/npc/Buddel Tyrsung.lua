-- Buddel Tyrsung - Converted from XML to Lua NpcType
-- Original XML: data/npc/Buddel Tyrsung.xml
-- Original Script: data/npc/scripts/Buddel Tyrsung.lua

local npcId = "Buddel Tyrsung"  -- Unique ID for spawn system
