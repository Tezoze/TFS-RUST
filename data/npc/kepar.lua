-- Kepar - Converted from XML to Lua NpcType
-- Original XML: data/npc/Kepar.xml
-- Original Script: data/npc/scripts/Kepar.lua
...
npcType:nameDescription("a kepar")
npcType:health(100)
...
npcType:outfit({lookType = 151, lookHead = 114, lookBody = 77, lookLegs = 110, lookFeet = 131})
