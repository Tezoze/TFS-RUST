-- Jessica - Converted from XML to Lua NpcType
-- Original XML: data/npc/Jessica.xml
-- Original Script: data/npc/scripts/Jessica.lua

local npcName = "Jessica"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a jessica")
npcType:health(100)
...
npcType:outfit({lookType = 140, lookHead = 114, lookBody = 16, lookLegs = 18, lookFeet = 33, lookAddons = 1})
...
local shopItems = {
    ...
    {id = 5799, buy = 0, sell = 3000, subType = 0, name = "golden figurine"},
