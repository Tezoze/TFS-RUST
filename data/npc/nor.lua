-- Nor - Converted from XML to Lua NpcType
-- Original XML: data/npc/Nor.xml
-- Original Script: data/npc/scripts/Nor.lua
...
npcType:outfit({lookType = 143, lookHead = 77, lookBody = 113, lookLegs = 19, lookFeet = 116})
