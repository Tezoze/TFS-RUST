-- ChrakNPC - Converted from XML to Lua NpcType
-- Original XML: data/npc/ChrakNPC.xml
-- Original Script: data/npc/scripts/Chrak.lua

local npcId = "ChrakNPC"  -- Unique ID for spawn system
local npcDisplayName = "Chrak"  -- Name shown in-game
