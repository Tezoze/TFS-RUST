-- Busty Bonecrusher - Converted from XML to Lua NpcType
-- Original XML: data/npc/Busty Bonecrusher.xml
-- Original Script: data/npc/scripts/Busty Bonecrusher.lua

local npcName = "Busty Bonecrusher"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a busty bonecrusher")
npcType:health(100)
...
npcType:outfit({lookType = 139, lookHead = 96, lookLegs = 66, lookFeet = 95})
