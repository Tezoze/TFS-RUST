-- Topsy - Converted from XML to Lua NpcType
-- Original XML: data/npc/Topsy.xml
-- Original Script: data/npc/scripts/Topsy.lua
...
npcType:nameDescription("a topsy")
npcType:health(100)
...
npcType:outfit({lookType = 139, lookHead = 78, lookBody = 52, lookLegs = 100, lookFeet = 115})
