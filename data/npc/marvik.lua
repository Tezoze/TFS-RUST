-- Marvik - Converted from XML to Lua NpcType
-- Original XML: data/npc/Marvik.xml
-- Original Script: data/npc/scripts/Marvik.lua

local npcName = "Marvik"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a marvik")
npcType:health(100)
...
npcType:outfit({lookType = 130, lookBody = 101, lookLegs = 120, lookFeet = 95})
