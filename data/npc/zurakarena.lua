-- zurakarena - Converted from XML to Lua NpcType
-- Original XML: data/npc/zurakarena.xml
-- Original Script: data/npc/scripts/Zurakarena.lua

local npcId = "zurakarena"  -- Unique ID for spawn system
local npcDisplayName = "Zurak"  -- Name shown in-game
