-- Gorn - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gorn.xml
-- Original Script: data/npc/scripts/Gorn.lua
...
npcType:nameDescription("a gorn")
npcType:health(100)
...
npcType:outfit({lookType = 129, lookHead = 58, lookBody = 68, lookLegs = 101, lookFeet = 95})
...
local shopItems = {
    {id = 1980, buy = 0, sell = 15, subType = 0, name = "green book"},
    {id = 1977, buy = 0, sell = 30, subType = 0, name = "orange book"},
    {id = 1978, buy = 0, sell = 20, subType = 0, name = "blue book"},
    {id = 1976, buy = 0, sell = 100, subType = 0, name = "gemmed book"},
    ...
    {id = 7696, buy = 0, sell = 5, subType = 0, name = "parchment"},
    ...
    {id = 1971, buy = 15, sell = 0, subType = 0, name = "brown book"},
    {id = 1972, buy = 15, sell = 0, subType = 0, name = "black book"},
    {id = 1973, buy = 15, sell = 0, subType = 0, name = "grey small book"},
    ...
    {id = 3942, buy = 2, sell = 0, subType = 0, name = "cup"},
    {id = 1952, buy = 12, sell = 0, subType = 0, name = "document"},
    {id = 2580, buy = 150, sell = 0, subType = 0, name = "fishing rod"},
    {id = 6387, buy = 30, sell = 0, subType = 0, name = "greeting card"},
    {id = 2600, buy = 10, sell = 0, subType = 0, name = "inkwell"},
    {id = 7244, buy = 10, sell = 0, subType = 0, name = "jug"},
    {id = 2420, buy = 35, sell = 0, subType = 0, name = "machete"},
    {id = 2012, buy = 4, sell = 0, subType = 0, name = "mug"},
    {id = 10519, buy = 20, sell = 0, subType = 0, name = "orange backpack"},
    {id = 10520, buy = 5, sell = 0, subType = 0, name = "orange bag"},
    {id = 1948, buy = 8, sell = 0, subType = 0, name = "parchment"},
    {id = 7535, buy = 8, sell = 0, subType = 0, name = "parchment"},
