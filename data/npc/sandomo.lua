-- Sandomo - Converted from XML to Lua NpcType
-- Original XML: data/npc/Sandomo.xml
-- Original Script: data/npc/scripts/Sandomo.lua

local npcName = "Sandomo"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a sandomo")
npcType:health(100)
...
npcType:outfit({lookType = 289, lookHead = 38, lookBody = 113, lookLegs = 2, lookFeet = 20, lookAddons = 1})
