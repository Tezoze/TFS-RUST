-- Chatterbone - Converted from XML to Lua NpcType
-- Original XML: data/npc/Chatterbone.xml
-- Original Script: data/npc/scripts/Chatterbone.lua

local npcName = "Chatterbone"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a chatterbone")
npcType:health(100)
