-- Stutch - Converted from XML to Lua NpcType
-- Original XML: data/npc/Stutch.xml
-- Original Script: data/npc/scripts/Stutch.lua

local npcName = "Stutch"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a stutch")
npcType:health(100)
