-- Guide Behil - Converted from XML to Lua NpcType
-- Original XML: data/npc/Guide Behil.xml
-- Original Script: data/npc/scripts/Guide Behil.lua

local npcName = "Guide Behil"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a guide behil")
npcType:health(100)
...
npcType:outfit({lookType = 146, lookHead = 114, lookBody = 87, lookLegs = 85, lookFeet = 126})
