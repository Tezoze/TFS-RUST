-- Gurbasch - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gurbasch.xml
-- Original Script: data/npc/scripts/Gurbasch.lua

local npcName = "Gurbasch"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gurbasch")
npcType:health(100)
