-- Tesha - Converted from XML to Lua NpcType
-- Original XML: data/npc/Tesha.xml
-- Original Script: data/npc/scripts/Tesha.lua
...
npcType:nameDescription("a tesha")
npcType:health(100)
...
npcType:outfit({lookType = 140, lookHead = 77, lookBody = 32, lookLegs = 81, lookFeet = 94})
