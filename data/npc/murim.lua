-- Murim - Converted from XML to Lua NpcType
-- Original XML: data/npc/Murim.xml
-- Original Script: data/npc/scripts/Murim.lua
...
npcType:nameDescription("a murim")
npcType:health(100)
...
npcType:outfit({lookType = 160, lookHead = 116, lookBody = 24, lookLegs = 21, lookFeet = 39})
