-- A Dead Bureaucrat4 - Converted from XML to Lua NpcType
-- Original XML: data/npc/A Dead Bureaucrat4.xml
-- Original Script: data/npc/scripts/A Dead Bureaucrat4.lua

local npcName = "A Dead Bureaucrat"
