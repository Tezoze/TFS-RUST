-- Omrabas - Converted from XML to Lua NpcType
-- Original XML: data/npc/Omrabas.xml
-- Original Script: data/npc/scripts/Omrabas.lua

local npcName = "Omrabas"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a omrabas")
npcType:health(100)
...
npcType:outfit({lookTypeEx = 2229})
