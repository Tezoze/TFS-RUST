-- Gerimor - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gerimor.xml
-- Original Script: data/npc/scripts/Gerimor.lua

local npcName = "Gerimor"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gerimor")
npcType:health(100)
...
npcType:outfit({lookType = 144, lookHead = 60, lookBody = 22, lookLegs = 24, lookFeet = 32, lookAddons = 2})
