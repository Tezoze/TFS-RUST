-- Iskan - Converted from XML to Lua NpcType
-- Original XML: data/npc/Iskan.xml
-- Original Script: data/npc/scripts/Iskan.lua
...
npcType:nameDescription("a iskan")
npcType:health(100)
...
npcType:outfit({lookType = 143, lookHead = 38, lookBody = 116, lookLegs = 38, lookFeet = 19})
