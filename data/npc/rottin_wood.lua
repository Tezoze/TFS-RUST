-- Rottin Wood - Converted from XML to Lua NpcType
-- Original XML: data/npc/Rottin Wood.xml
-- Original Script: data/npc/scripts/Rottin Wood.lua

local npcName = "Rottin Wood"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a rottin wood")
npcType:health(100)
...
npcType:outfit({lookType = 129, lookHead = 114, lookBody = 118, lookLegs = 116, lookFeet = 97, lookAddons = 3})
npcType:speechBubble(SPEECHBUBBLE_1)
