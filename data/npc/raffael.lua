-- Raffael - Converted from XML to Lua NpcType
-- Original XML: data/npc/Raffael.xml
-- Original Script: data/npc/scripts/Raffael.lua

local npcName = "Raffael"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a raffael")
npcType:health(100)
...
npcType:outfit({lookType = 140, lookHead = 60, lookBody = 24, lookLegs = 38})
