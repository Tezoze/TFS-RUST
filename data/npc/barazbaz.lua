-- Barazbaz - Converted from XML to Lua NpcType
-- Original XML: data/npc/Barazbaz.xml
-- Original Script: data/npc/scripts/Barazbaz.lua

local npcName = "Barazbaz"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a barazbaz")
npcType:health(100)
...
npcType:outfit({lookType = 132, lookHead = 76, lookBody = 55, lookLegs = 49, lookFeet = 95})
