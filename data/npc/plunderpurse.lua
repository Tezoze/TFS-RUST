-- Plunderpurse - Converted from XML to Lua NpcType
-- Original XML: data/npc/Plunderpurse.xml
-- Original Script: data/npc/scripts/Plunderpurse.lua

local npcName = "Plunderpurse"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a plunderpurse")
npcType:health(100)
...
npcType:outfit({lookType = 151, lookHead = 114, lookBody = 131, lookFeet = 20, lookAddons = 1})
