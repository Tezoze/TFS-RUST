-- A Dead Bureaucrat2 - Converted from XML to Lua NpcType
-- Original XML: data/npc/A Dead Bureaucrat2.xml
-- Original Script: data/npc/scripts/A Dead Bureaucrat2.lua
