-- King Spell - Converted from XML to Lua NpcType
-- Original XML: data/npc/King Spell.xml
-- Original Script: data/npc/scripts/spells/King Spell.lua

local npcName = "King Spell"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a king spell")
npcType:health(100)
