-- Oldrak - Converted from XML to Lua NpcType
-- Original XML: data/npc/Oldrak.xml
-- Original Script: data/npc/scripts/Oldrak.lua

local npcName = "Oldrak"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a oldrak")
npcType:health(150)
...
npcType:outfit({lookType = 57, lookHead = 115, lookBody = 113, lookLegs = 31, lookFeet = 38, lookAddons = 3})
...
local shopItems = {
    {id = 1970, buy = 1000, sell = 0, subType = 0, name = "book"},
}
