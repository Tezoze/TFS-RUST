-- Gnomilly - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gnomilly.xml
-- Original Script: data/npc/scripts/Gnomilly.lua

local npcName = "Gnomilly"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gnomilly")
npcType:health(100)
...
npcType:outfit({lookType = 507, lookHead = 14, lookBody = 15, lookLegs = 91, lookFeet = 92})
