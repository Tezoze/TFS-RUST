-- The Bone Master - Converted from XML to Lua NpcType
-- Original XML: data/npc/The Bone Master.xml
-- Original Script: data/npc/scripts/The Bone Master.lua

local npcName = "The Bone Master"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a the bone master")
npcType:health(100)
...
npcType:outfit({lookType = 145, lookAddons = 2})
