-- Griphon - Converted from XML to Lua NpcType
-- Original XML: data/npc/Griphon.xml
-- Original Script: data/npc/scripts/spells/rune spell.lua

local npcName = "Griphon"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a griphon")
npcType:health(100)
