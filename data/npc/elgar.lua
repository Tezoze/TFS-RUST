-- Elgar - Converted from XML to Lua NpcType
-- Original XML: data/npc/Elgar.xml
-- Original Script: data/npc/scripts/Elgar.lua
...
npcType:nameDescription("a elgar")
npcType:health(100)
...
npcType:outfit({lookType = 160, lookHead = 77, lookBody = 113, lookLegs = 116, lookFeet = 95})
