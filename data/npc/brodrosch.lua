-- Brodrosch - Converted from XML to Lua NpcType
-- Original XML: data/npc/Brodrosch.xml
-- Original Script: data/npc/scripts/Brodrosch.lua

local npcName = "Brodrosch"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a brodrosch")
npcType:health(100)
