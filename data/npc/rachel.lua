-- Rachel - Converted from XML to Lua NpcType
-- Original XML: data/npc/Rachel.xml
-- Original Script: data/npc/scripts/Rachel.lua

local npcName = "Rachel"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a rachel")
npcType:health(100)
...
npcType:outfit({lookType = 136, lookHead = 58, lookBody = 84, lookLegs = 86, lookFeet = 114})
