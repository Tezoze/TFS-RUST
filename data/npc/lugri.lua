-- Lugri - Converted from XML to Lua NpcType
-- Original XML: data/npc/Lugri.xml
-- Original Script: data/npc/scripts/Lugri.lua
...
npcType:nameDescription("a lugri")
npcType:health(100)
...
npcType:outfit({lookType = 145, lookHead = 132, lookBody = 114, lookFeet = 38, lookAddons = 3})
