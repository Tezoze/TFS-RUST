-- Albinius - Converted from XML to Lua NpcType
-- Original XML: data/npc/Albinius.xml
-- Original Script: data/npc/scripts/Albinius.lua

local npcName = "Albinius"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a albinius")
npcType:health(100)
...
npcType:outfit({lookType = 634, lookBody = 19, lookLegs = 86, lookFeet = 60})
