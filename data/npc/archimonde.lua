-- Archimonde - Converted from XML to Lua NpcType
-- Original XML: data/npc/Archimonde.xml
-- Original Script: data/npc/scripts/spells/Archimonde Spell.lua

local npcName = "Archimonde"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a archimonde")
npcType:health(100)
