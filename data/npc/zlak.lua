-- Zlak - Converted from XML to Lua NpcType
-- Original XML: data/npc/Zlak.xml
-- Original Script: data/npc/scripts/Zlak.lua
...
npcType:nameDescription("a zlak")
npcType:health(100)
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "mission") then
		...
		elseif player:getStorageValue(Storage.WrathoftheEmperor.Questline) == 24 and player:getStorageValue(Storage.WrathoftheEmperor.Mission07) == 6 then
			player:unregisterEvent("WotELizardKill")
