-- Guide Edna - Converted from XML to Lua NpcType
-- Original XML: data/npc/Guide Edna.xml
-- Original Script: data/npc/scripts/Guide Edna.lua

local npcName = "Guide Edna"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a guide edna")
npcType:health(100)
...
npcType:outfit({lookType = 276, lookHead = 58, lookBody = 43, lookLegs = 38, lookFeet = 76})
