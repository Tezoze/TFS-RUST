-- Bozo - Converted from XML to Lua NpcType
-- Original XML: data/npc/Bozo.xml
-- Original Script: data/npc/scripts/Bozo.lua
...
npcType:nameDescription("a bozo")
npcType:health(100)
...
npcType:outfit({lookType = 273, lookBody = 77, lookLegs = 80, lookFeet = 79, lookAddons = 3})
