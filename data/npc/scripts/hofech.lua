...
local npc = NpcType("Hofech")
npc:appearance({ lookType = 128, lookHead = 95, lookBody = 2, lookLegs = 2, lookFeet = 57 })
	...
	rules = {
		{
			...
			actions = {
				{ say = "Welcome %N! Have a look at my wares, my friend." },
			},
		},
		{
			line = 14,
		...
		},
		{
			...
			actions = {
				{ say = "I am selling furniture and equipment to grace the homes." },
			},
		},
		{
			line = 24,
		...
		},
		{
			...
			actions = {
				{ say = "The caliph has the finest home and interior decoration in Darashia." },
			},
		},
		{
			line = 26,
		...
		},
		{
			...
			actions = {
				{ say = "The prophet is alive! Both in the heavens and in our our hearts." },
			},
		},
		{
			line = 28,
			...
			actions = {
				{ say = "I don't know about such a person, my friend." },
			},
		},
		{
			line = 29,
			...
			actions = {
				{ say = "I think if that sword really existed, it would make a splendid decoration for any wall." },
			},
		},
		{
			line = 30,
			...
			actions = {
				{ say = "The wood we are using to make our exquisite furniture is partly supplied by Thais." },
			},
		},
		{
			line = 31,
			...
			actions = {
				{ say = "One day I will take my flying carpet to see the whole world." },
			},
		},
		{
			line = 32,
			...
			actions = {
				{ say = "I was not there yet. But I plan to travel there one day." },
			},
		},
		{
			line = 34,
		...
		},
		{
			...
			actions = {
				{ say = "My offers are extraordinarily cheap, given the fine quality of our stock. Just look at that table!" },
			},
		},
		{
			line = 41,
			...
			actions = {
				{ say = "No no, I don't sell any carpets." },
			},
		},
