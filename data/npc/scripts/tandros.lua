...
npc:dialogue(NpcDialogue({
	...
	rules = {
		...
		-- from gen-t-wands-prem-s.ndb:10
		{
			line = 10,
			when = {
				{ expr = { session = "topic" }, op = "=", rhs = 90 },
		...
		-- from gen-t-wands-prem-s.ndb:12
		{
			line = 12,
			when = {
		...
		-- from gen-t-wands-prem-s.ndb:13
		{
			line = 13,
			when = {
				{ expr = { session = "topic" }, op = "=", rhs = 91 },
		...
		-- from gen-t-wands-prem-s.ndb:14
		{
			line = 14,
			when = {
				{ expr = { session = "topic" }, op = "=", rhs = 91 },
		...
		-- from gen-t-wands-prem-s.ndb:16
		{
			line = 16,
			when = {
				{ property = "sorcerer" },
		...
		-- from gen-t-wands-prem-s.ndb:17
		{
			line = 17,
			when = {
				{ property = "druid" },
		...
		-- from gen-t-wands-prem-s.ndb:19
		{
			line = 19,
			when = {
				{ words = { "wand" } },
		...
		-- from gen-t-wands-prem-s.ndb:20
		{
			line = 20,
			when = {
				{ words = { "wand" } },
		...
		-- from gen-t-wands-prem-s.ndb:21
		{
			line = 21,
			when = {
				{ words = { "wand" } },
		...
		-- from gen-t-wands-prem-s.ndb:22
		{
			line = 22,
			when = {
				{ words = { "wand" } },
		...
		-- from gen-t-wands-prem-s.ndb:23
		{
			line = 23,
			when = {
				{ words = { "wand" } },
		...
		-- from gen-t-wands-prem-s.ndb:25
		{
			line = 25,
			when = {
				{ words = { "snakebite" } },
		...
		-- from gen-t-wands-prem-s.ndb:26
		{
			line = 26,
			when = {
				{ words = { "moonlight" } },
		...
		-- from gen-t-wands-prem-s.ndb:27
		{
			line = 27,
			when = {
				{ words = { "volcanic" } },
		...
		-- from gen-t-wands-prem-s.ndb:28
		{
			line = 28,
			when = {
				{ words = { "quagmire" } },
		...
		-- from gen-t-wands-prem-s.ndb:29
		{
			line = 29,
			when = {
				{ words = { "tempest" } },
		...
		-- from gen-t-wands-prem-s.ndb:31
		{
			line = 31,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:32
		{
			line = 32,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:33
		{
			line = 33,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:34
		{
			line = 34,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:35
		{
			line = 35,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:37
		{
			line = 37,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:38
		{
			line = 38,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:39
		{
			line = 39,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:40
		{
			line = 40,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:41
		{
			line = 41,
			when = {
				{ capture = 1 },
		...
		-- from gen-t-wands-prem-s.ndb:44
		{
			line = 44,
			when = {
		...
		-- from gen-t-wands-prem-s.ndb:45
		{
			line = 45,
			when = {
				{ expr = { session = "topic" }, op = "=", rhs = 92 },
		...
		-- from gen-t-wands-prem-s.ndb:46
		{
			line = 46,
			when = {
				{ expr = { session = "topic" }, op = "=", rhs = 92 },
