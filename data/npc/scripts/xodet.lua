...
local npc = NpcType("Xodet")
npc:appearance({ lookType = 130, lookHead = 19, lookBody = 86, lookLegs = 87, lookFeet = 95 })
...
npc:dialogue(NpcDialogue({
	...
	rules = {
		...
		},
		{
			...
			actions = {
				{ say = "Sorry %N, I am already talking to a customer. Wait a minute, please." },
				{ queue = true },
			},
		},
		{
		...
		},
		{
			...
			actions = {
				{ say = "I'm Xodet, the owner of this shop." },
			},
		},
		{
			line = 24,
			...
			actions = {
				{ say = "I'm sorcerer and trade with all kinds of magic items." },
			},
		},
		{
			line = 25,
			...
			actions = {
				{ say = "There is a sorcerer guild in Thais. Just go in the east of the town, it is easly to find." },
			},
		},
		{
			line = 27,
