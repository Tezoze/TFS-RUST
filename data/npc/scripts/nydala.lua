...
local npc = NpcType("Nydala")
npc:appearance({ lookType = 136, lookHead = 76, lookBody = 86, lookLegs = 86, lookFeet = 96 })
	...
	rules = {
		{
			...
			actions = {
				{ say = "Welcome to Carlin Furniture Store, %N." },
			},
		},
		{
			line = 14,
		...
		},
		{
			...
			actions = {
				{ say = "My name is Nydala. I run this store." },
			},
		},
		{
			line = 24,
