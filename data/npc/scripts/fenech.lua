...
local npc = NpcType("Fenech")
npc:appearance({ lookType = 132, lookHead = 76, lookBody = 40, lookLegs = 49, lookFeet = 117 })
...
npc:dialogue(NpcDialogue({
	...
	rules = {
		...
		},
		{
			...
			actions = {
				{ say = "I sell runes, wands, rods and spellbooks." },
			},
		},
		{
			line = 27,
		...
		},
		{
			...
			actions = {
				{ say = "Ask the guards for locations." },
			},
		},
		{
			line = 31,
		...
		},
		{
			...
			actions = {
				{ say = "I don't know. Read some books." },
			},
		},
		{
			line = 36,
			...
			actions = {
				{ say = "Scarabs are dangerous. Stay away from them like I do." },
			},
		},
		{
			line = 37,
			...
			actions = {
				{ say = "I know only Ankrahmun. What else could there be?" },
			},
		},
		{
			line = 38,
			...
			actions = {
				{ say = "I don't know any foreign places or races." },
			},
		},
		{
			line = 39,
		...
		},
		{
			...
			actions = {
				{ say = "Its somewhere in the north as far as I know." },
			},
		},
		{
			line = 50,
			...
			actions = {
				{ say = "I am not a studied person. Ask someone else." },
			},
		},
		{
			line = 51,
			...
			actions = {
				{ say = "Its my home and all I know." },
			},
		},
		{
			line = 53,
			...
			actions = {
				{ say = "Ask the priest in the temple." },
			},
		},
		{
			line = 54,
