...
local npc = NpcType("Rokyn")
npc:appearance({ lookType = 160, lookHead = 58, lookBody = 87, lookLegs = 57, lookFeet = 95 })
	...
	rules = {
		{
			...
			actions = {
				{ say = "Hiho, Hiho, %N! What can I do for you?" },
			},
		},
		{
			line = 14,
		...
		},
		{
			...
			actions = {
				{ say = "I can change money for you." },
			},
		},
		{
			line = 27,
			...
			actions = {
				{ say = "I am Rokyn Pursesniffer, son of Fire, proud member of the Molten Rock fellowship." },
			},
		},
		{
			line = 28,
