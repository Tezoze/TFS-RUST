...
local npc = NpcType("Ukea")
npc:appearance({ lookType = 144, lookHead = 78, lookBody = 58, lookLegs = 64, lookFeet = 58 })
	...
	rules = {
		{
			...
			actions = {
				{ say = "Ashari %N. Welcome to Ab'Dendriel Furniture Store." },
			},
		},
		{
			line = 14,
		...
		},
		{
			...
			actions = {
				{ say = "My name is Ukea. I run this store." },
			},
		},
		{
			line = 27,
