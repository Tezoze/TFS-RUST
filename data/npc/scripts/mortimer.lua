	...
	rules = {
		...
		},
		{
			...
			actions = {
				...
				{ say = "Please travel to our base in Port Hope and ask them to mail us their latest research reports. Then return here and ask about new missions." },
				{ setQuestValue = { id = 320, value = 2 } },
			},
		},
		{
			line = 33,
		...
		},
		{
			...
			when = {
				{ words = { "mission" } },
				{ expr = { questValue = 320 }, op = "=", rhs = 4 },
			},
			actions = {
				{ say = "The reports from Port Hope have already arrived here and our progress is astonishing. We think it is possible to create an astral bridge between our bases. Are you interested to assist us with this?" },
