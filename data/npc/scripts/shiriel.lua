...
local npc = NpcType("Shiriel")
npc:appearance({ lookType = 144, lookHead = 2, lookBody = 103, lookLegs = 0, lookFeet = 95 })
...
npc:dialogue(NpcDialogue({
	...
	rules = {
		...
		},
		{
			...
			actions = {
				{ say = "I sell mystic runes, spellbooks, wands, rods and fluids of life or mana." },
			},
		},
		{
			line = 27,
		...
		},
		{
			...
			actions = {
				{ say = "Time was mastered by my people long ago." },
			},
		},
		{
			line = 30,
			...
			actions = {
				{ say = "Our noble race has knowledge of secrets beyond your comprehension." },
			},
		},
		{
			line = 31,
		...
		},
		{
			...
			actions = {
				{ say = "Cursed with a short livespan and not worth to be remembered." },
			},
		},
		{
			line = 33,
			...
			actions = {
				{ say = "We should eradicate them all." },
			},
		},
		{
			line = 34,
			...
			actions = {
				{ say = "We are the teachers to the other castes." },
			},
		},
		{
			line = 35,
			...
			actions = {
				{ say = "Their knowledge is limited." },
			},
		},
		{
			line = 36,
			...
			actions = {
				{ say = "They lack the patience that suits a race with our lifespan." },
			},
		},
		{
			line = 37,
			...
			actions = {
				{ say = "I think they are lost forever." },
			},
		},
		{
			line = 38,
			...
			actions = {
				{ say = "They were not prepared for what they encountered in their quest for knowledge. WE will be prepared." },
			},
		},
		{
			line = 39,
		...
		},
		{
			...
			actions = {
				{ say = "I have no time for superstition." },
			},
		},
		{
			line = 41,
			...
			actions = {
				{ say = "I would love to analyse it one day." },
			},
		},
		{
			line = 42,
			...
			actions = {
				{ say = "News are secrets and you are not worthy of my secrets." },
			},
		},
		{
			line = 43,
			...
			actions = {
				{ say = "I could teach you some spells ... but I won't." },
			},
		},
		{
			line = 45,
