...
local npc = NpcType("Bezil")
npc:appearance({ lookType = 160, lookHead = 116, lookBody = 79, lookLegs = 117, lookFeet = 57 })
	...
	rules = {
		{
			...
			actions = {
				{ say = "Hiho, Bezil at your service, %N." },
			},
		},
		{
			line = 14,
		...
		},
		{
			...
			actions = {
				{ say = "Hey, I am busy. I'll be with you in a minute, %N." },
				{ queue = true },
			},
		},
		{
		...
		},
		{
			...
			actions = {
				{ say = "I am Bezil Coinbiter, daughter of Earth, of the Molten Rocks. I and my bro' Nezil are selling stuff, ye' know?" },
			},
		},
		{
			line = 39,
		...
		},
		{
			...
			actions = {
				{ say = "Let me see ... we have shovels, picks, scythes, bags, ropes, backpacks, scrolls, watches, some lightsources, fishing rods, sixpacks of worms and other stuff." },
			},
		},
		{
			line = 44,
			...
			actions = {
				{ say = "Oh, things like crowbars, water hoses, presents, buckets, bottles, and the like." },
			},
		},
		{
			line = 45,
