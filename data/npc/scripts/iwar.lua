...
local npc = NpcType("Iwar")
npc:appearance({ lookType = 160, lookHead = 58, lookBody = 108, lookLegs = 63, lookFeet = 76 })
	...
	rules = {
		{
			...
			actions = {
				{ say = "Hiho %N! Welcome to Kazordoon Furniture Store." },
			},
		},
		{
			line = 14,
		...
		},
		{
			...
			actions = {
				{ say = "Me is Iwar Woodpecker, son of Earth, from the Savage Axes. Me run this store." },
			},
		},
		{
			line = 26,
			...
			actions = {
				{ say = "You moving to new home? Me specialist for equipping it." },
			},
		},
		{
			line = 27,
			...
			actions = {
				{ say = "Time is %T. You needing clock for your house?" },
			},
		},
		{
			line = 28,
			...
			actions = {
				{ say = "You meaning my specials, eh?" },
			},
		},
		{
			line = 30,
			...
			actions = {
				{ say = "Me selling statues, tables, chairs, flowers, pillows, pottery, instruments, decoration, tapestries and containers." },
			},
		},
		{
			line = 31,
		...
		},
		{
			...
			actions = {
				{ say = "My offers permanently extraordinary cheap." },
			},
		},
