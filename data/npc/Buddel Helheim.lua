-- Buddel Helheim - Converted from XML to Lua NpcType
-- Original XML: data/npc/Buddel Helheim.xml
-- Original Script: data/npc/scripts/Buddel Helheim.lua

local npcId = "Buddel Helheim"  -- Unique ID for spawn system
