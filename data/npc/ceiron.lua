-- Ceiron - Converted from XML to Lua NpcType
-- Original XML: data/npc/Ceiron.xml
-- Original Script: data/npc/scripts/Ceiron.lua

local npcName = "Ceiron"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a ceiron")
npcType:health(100)
...
npcType:outfit({lookType = 144, lookHead = 78, lookBody = 100, lookLegs = 119, lookFeet = 116, lookAddons = 3})
