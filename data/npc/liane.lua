-- Liane - Converted from XML to Lua NpcType
-- Original XML: data/npc/Liane.xml
-- Original Script: data/npc/scripts/Liane.lua
...
npcType:nameDescription("a liane")
npcType:health(100)
...
npcType:outfit({lookType = 136, lookHead = 77, lookBody = 98, lookLegs = 79, lookFeet = 114})
