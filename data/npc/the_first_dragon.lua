-- The First Dragon - Converted from XML to Lua NpcType
-- Original XML: data/npc/The First Dragon.xml
-- Original Script: data/npc/scripts/The First Dragon.lua

local npcName = "The First Dragon"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a the first dragon")
npcType:health(100)
...
npcType:outfit({lookType = 947, lookHead = 113, lookBody = 117, lookLegs = 119, lookFeet = 80, lookAddons = 3})
