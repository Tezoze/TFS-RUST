-- Denominator - Converted from XML to Lua NpcType
-- Original XML: data/npc/Denominator.xml
-- Original Script: data/npc/scripts/Denominator.lua

local npcName = "Denominator"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a denominator")
npcType:health(100)
...
npcType:outfit({lookTypeEx = 1442})
