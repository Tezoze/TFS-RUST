-- Duria - Converted from XML to Lua NpcType
-- Original XML: data/npc/Duria.xml
-- Original Script: data/npc/scripts/Duria.lua
...
npcType:nameDescription("a duria")
npcType:health(100)
...
npcHandler:setMessage(MESSAGE_WALKAWAY, 'Be careful out there, jawoll.')
