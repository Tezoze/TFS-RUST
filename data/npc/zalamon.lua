-- Zalamon - Converted from XML to Lua NpcType
-- Original XML: data/npc/Zalamon.xml
-- Original Script: data/npc/scripts/Zalamon.lua

local npcName = "Zalamon"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a zalamon")
npcType:health(100)
