-- Fa'Hradin - Converted from XML to Lua NpcType
-- Original XML: data/npc/Fa'Hradin.xml
-- Original Script: data/npc/scripts/Fa_hraden.lua

local npcName = "Fa'Hradin"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a fa'hradin")
npcType:health(100)
