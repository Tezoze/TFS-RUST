-- Appaloosa - Converted from XML to Lua NpcType
-- Original XML: data/npc/Appaloosa.xml
-- Original Script: data/npc/scripts/Appaloosa.lua

local npcName = "Appaloosa"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a appaloosa")
npcType:health(100)
...
npcType:outfit({lookType = 140, lookHead = 114, lookLegs = 114})
