-- Hanna - Converted from XML to Lua NpcType
-- Original XML: data/npc/Hanna.xml
-- Original Script: data/npc/scripts/Hanna.lua
...
npcType:nameDescription("a hanna")
npcType:health(100)
...
npcType:outfit({lookType = 136, lookHead = 96, lookBody = 65, lookFeet = 96, lookAddons = 2})
