-- Gnomeral - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gnomeral.xml
-- Original Script: data/npc/scripts/Gnomeral.lua

local npcName = "Gnomeral"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gnomeral")
npcType:health(100)
