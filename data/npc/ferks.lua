-- Ferks - Converted from XML to Lua NpcType
-- Original XML: data/npc/Ferks.xml
-- Original Script: data/npc/scripts/Ferks.lua
...
npcType:nameDescription("a ferks")
npcType:health(100)
...
npcType:outfit({lookType = 128, lookHead = 59, lookBody = 71, lookLegs = 119, lookFeet = 116})
