-- Gnommander - Converted from XML to Lua NpcType
-- Original XML: data/npc/Gnommander.xml
-- Original Script: data/npc/scripts/Gnommander.lua

local npcName = "Gnommander"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a gnommander")
npcType:health(100)
...
npcType:outfit({lookType = 493, lookHead = 59, lookBody = 57, lookLegs = 39, lookFeet = 38})
