-- Ajax - Converted from XML to Lua NpcType
-- Original XML: data/npc/Ajax.xml
-- Original Script: data/npc/scripts/Ajax.lua
...
npcType:nameDescription("a ajax")
npcType:health(100)
...
npcType:outfit({lookType = 143, lookHead = 78, lookBody = 101, lookLegs = 120, lookFeet = 94, lookAddons = 1})
