-- Aneus - Converted from XML to Lua NpcType
-- Original XML: data/npc/Aneus.xml
-- Original Script: data/npc/scripts/Aneus.lua
...
npcType:nameDescription("a aneus")
npcType:health(100)
...
npcType:outfit({lookType = 129, lookHead = 38, lookBody = 50, lookLegs = 58, lookFeet = 116})
