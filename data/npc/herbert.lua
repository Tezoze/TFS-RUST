-- Herbert - Converted from XML to Lua NpcType
-- Original XML: data/npc/Herbert.xml
-- Original Script: data/npc/scripts/Herbert.lua

local npcName = "Herbert"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a herbert")
npcType:health(100)
...
npcType:outfit({lookType = 132, lookHead = 97, lookBody = 93, lookLegs = 36, lookFeet = 93})
