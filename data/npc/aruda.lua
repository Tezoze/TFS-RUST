-- Aruda - Converted from XML to Lua NpcType
-- Original XML: data/npc/Aruda.xml
-- Original Script: data/npc/scripts/Aruda.lua
...
npcType:nameDescription("a aruda")
npcType:health(100)
...
npcType:outfit({lookType = 140, lookHead = 77, lookBody = 81, lookLegs = 79, lookFeet = 95})
