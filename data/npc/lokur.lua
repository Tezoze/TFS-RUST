-- Lokur - Converted from XML to Lua NpcType
-- Original XML: data/npc/Lokur.xml
-- Original Script: data/npc/scripts/Lokur.lua
...
npcType:nameDescription("a lokur")
npcType:health(100)
...
npcType:outfit({lookType = 160, lookHead = 57, lookBody = 79, lookLegs = 79, lookFeet = 95})
