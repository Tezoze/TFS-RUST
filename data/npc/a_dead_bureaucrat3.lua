-- A Dead Bureaucrat3 - Converted from XML to Lua NpcType
-- Original XML: data/npc/A Dead Bureaucrat3.xml
-- Original Script: data/npc/scripts/A Dead Bureaucrat3.lua
