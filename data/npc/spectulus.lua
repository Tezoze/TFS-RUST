-- Spectulus - Converted from XML to Lua NpcType
-- Original XML: data/npc/Spectulus.xml
-- Original Script: data/npc/scripts/Spectulus.lua

local npcName = "Spectulus"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a spectulus")
npcType:health(100)
...
npcType:outfit({lookType = 130, lookBody = 77, lookLegs = 78, lookFeet = 97, lookAddons = 2})
