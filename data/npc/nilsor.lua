-- Nilsor - Converted from XML to Lua NpcType
-- Original XML: data/npc/Nilsor.xml
-- Original Script: data/npc/scripts/Nilsor.lua

local npcName = "Nilsor"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a nilsor")
npcType:health(100)
...
npcType:outfit({lookType = 154, lookHead = 41, lookBody = 116, lookLegs = 95, lookFeet = 114})
