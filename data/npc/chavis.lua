-- Chavis - Converted from XML to Lua NpcType
-- Original XML: data/npc/Chavis.xml
-- Original Script: data/npc/scripts/Chavis.lua

local npcName = "Chavis"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a chavis")
npcType:health(100)
...
npcType:outfit({lookType = 128, lookHead = 96, lookBody = 43, lookLegs = 20, lookFeet = 76, lookAddons = 2})
