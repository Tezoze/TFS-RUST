-- Jean Claude - Converted from XML to Lua NpcType
-- Original XML: data/npc/Jean Claude.xml
-- Original Script: data/npc/scripts/Jean Claude.lua

local npcName = "Jean Claude"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a jean claude")
npcType:health(100)
