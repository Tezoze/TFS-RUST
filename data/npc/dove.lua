-- Dove - Converted from XML to Lua NpcType
-- Original XML: data/npc/Dove.xml
-- Original Script: data/npc/scripts/Dove.lua
...
npcType:nameDescription("a dove")
npcType:health(100)
...
npcType:outfit({lookType = 136, lookHead = 59, lookBody = 86, lookLegs = 106, lookFeet = 115})
