-- Noozer - Converted from XML to Lua NpcType
-- Original XML: data/npc/Noozer.xml
-- Original Script: data/npc/scripts/Noozer.lua

local npcName = "Noozer"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a noozer")
npcType:health(100)
...
npcType:outfit({lookType = 430, lookHead = 39, lookBody = 39, lookLegs = 39, lookFeet = 19})
