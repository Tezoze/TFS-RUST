-- Exchanger - Converted from XML to Lua NpcType
-- Original XML: data/npc/Exchanger.xml
-- Original Script: data/npc/scripts/Exchanger.lua
...
npcType:nameDescription("a exchanger")
npcType:health(100)
...
npcType:outfit({lookType = 152, lookHead = 85, lookBody = 86, lookLegs = 106, lookFeet = 86, lookAddons = 3})
