-- Shoddy Beggar - Converted from XML to Lua NpcType
-- Original XML: data/npc/Shoddy Beggar.xml
-- Original Script: data/npc/scripts/Shoddy Beggar.lua

local npcName = "Shoddy Beggar"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a shoddy beggar")
npcType:health(100)
...
npcType:outfit({lookType = 153, lookHead = 20, lookBody = 39, lookLegs = 39, lookFeet = 116, lookAddons = 3})
