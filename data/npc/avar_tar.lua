-- Avar Tar - Converted from XML to Lua NpcType
-- Original XML: data/npc/Avar Tar.xml
-- Original Script: data/npc/scripts/Avar Tar.lua

local npcName = "Avar Tar"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a avar tar")
npcType:health(100)
