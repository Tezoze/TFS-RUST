-- Emperor Kruzak - Converted from XML to Lua NpcType
-- Original XML: data/npc/Emperor Kruzak.xml
-- Original Script: data/npc/scripts/Emperor Kruzak.lua

local npcName = "Emperor Kruzak"
local npcType = Game.createNpcType(npcName)

-- NPC Properties (from XML)
npcType:name(npcName)
npcType:nameDescription("a emperor kruzak")
npcType:health(100)
