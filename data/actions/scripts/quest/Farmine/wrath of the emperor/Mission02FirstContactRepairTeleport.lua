...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	-- bowl with sacred water on fire basin
	elseif item.itemid == 12289 and target.actionid == 8024 then
		player:say("You pour the sacred water into the fire basin and it begins to glow. As the water evaporates, a lump of sacred coal remains.", TALKTYPE_MONSTER_SAY)
		item:transform(12290)
	-- sacred coal on water next to jade basin
