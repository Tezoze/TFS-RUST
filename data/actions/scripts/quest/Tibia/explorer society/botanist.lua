function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if target.itemid == 4138 and player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 17 then
		player:setStorageValue(Storage.ExplorerSociety.ThePlantCollection, 18)
		toPosition:sendMagicEffect(CONST_ME_MAGIC_BLUE)
		item:transform(4870)
	elseif target.itemid == 4149 and player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 20 then
		player:setStorageValue(Storage.ExplorerSociety.ThePlantCollection, 21)
		toPosition:sendMagicEffect(CONST_ME_MAGIC_BLUE)
		item:transform(4871)
	elseif target.itemid == 4142 and player:getStorageValue(Storage.ExplorerSociety.ThePlantCollection) == 23 then
