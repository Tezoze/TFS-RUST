...
local function highlightTrackedLoot(contentDesc, player)
	-- For now, just return the content as-is since we can't easily access client-side tracking
	-- The client-side ItemsDatabase.setColorLootMessage will handle highlighting
	return contentDesc
end
