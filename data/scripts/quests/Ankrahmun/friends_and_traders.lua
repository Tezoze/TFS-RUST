...
-- Storage keys defined in data/lib/core/storages.lua under Storage.FriendsAndTraders

local friendsAndTradersQuest = GlobalEvent("FriendsAndTradersQuestStart")

function friendsAndTradersQuest.onStartup()
	local quest = Game.createQuest("Friends and Traders", {
		storageId = Storage.FriendsAndTraders.Questline,  -- 12400
		storageValue = 1,
		missions = {
			{
				name = "The Sweaty Cyclops",
				storageId = Storage.FriendsAndTraders.TheSweatyCyclops,  -- 12401
				startValue = 1,
				endValue = 2,
				description = {
			...
			},
			{
				...
				storageId = Storage.FriendsAndTraders.TheMermaidMarina,  -- 12402
				startValue = 1,
				endValue = 2,
				description = {
			...
			},
			{
				...
				storageId = Storage.FriendsAndTraders.TheBlessedStake,  -- 12403
				startValue = 1,
				endValue = 12,
				description = {
	...
	quest:register()
	print(">> Registered quest: Friends and Traders (3 missions)")
	return true
end

friendsAndTradersQuest:register()
